    ...
    public partial class ucAddUnit : UserControl
    {
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    else
                    {
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            addtable(dt.Rows[i]["iChecked"].ToString(), "", "", "",
                            dt.Rows[i]["DetectUnitName"].ToString(), dt.Rows[i]["DetectUnitNature"].ToString(), "", "");
                ...
                if (e.ColumnIndex == 0 && e.RowIndex > -1)
                {
                    ...
                    if (Global.Platform == "DYKJFW")
                    {
                        if (CheckDatas.Rows[e.RowIndex].Cells["IsSelects"].Value.ToString() == "False")
                        {
                            ...
                            //Global.jianceyuan = CheckDatas.Rows[e.RowIndex].Cells["被检单位编号"].Value.ToString();
                    ...
                    else
                    {
                        if (CheckDatas.Rows[e.RowIndex].Cells["默认选择"].Value.ToString() == "False")
                        {
                            ...
                            for (int j = 0; j < CheckDatas.Rows.Count; j++)
                            {
                                if (j != e.RowIndex)
                                {
                                    ...
                                    sql.updateBasicIn(CheckDatas.Rows[j].Cells["默认选择"].Value.ToString(), "",
                                             "", "",
                                            CheckDatas.Rows[j].Cells["被检单位"].Value.ToString(), CheckDatas.Rows[j].Cells["被检单位编号"].Value.ToString(),
                                             "", "", out err);
                        ...
                        else
                        {
                            ...
                            sql.updateBasicIn(CheckDatas.Rows[e.RowIndex].Cells["默认选择"].Value.ToString(), "",
                                             "", "",
                                              CheckDatas.Rows[e.RowIndex].Cells["被检单位"].Value.ToString(), CheckDatas.Rows[e.RowIndex].Cells["被检单位编号"].Value.ToString(),
                                               "", "", out err);
        ...
        private void btnclear_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sb.AppendFormat("DetectUnitNature='{0}' ", CheckDatas.Rows[CheckDatas.CurrentCell.RowIndex].Cells["被检单位编号"].Value.ToString());
        ...
        private void btnrepair_Click(object sender, EventArgs e)
        {
            try
            {
                if (CheckDatas.SelectedRows.Count > 0)
                {
                    ...
                    a[0, 4] = CheckDatas.Rows[CheckDatas.CurrentCell.RowIndex].Cells["被检单位编号"].Value.ToString();//被检单位地址
