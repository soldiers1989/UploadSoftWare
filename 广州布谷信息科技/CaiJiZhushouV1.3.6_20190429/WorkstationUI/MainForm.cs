    ...
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                Global.MachineSerialCode = ConfigurationManager.AppSettings["IntrumentSeriersNum"];//设备编号
                Global.regions = ConfigurationManager.AppSettings["Organize"];//所属区域
                Global.LaboratoryNum = ConfigurationManager.AppSettings["OrganizeNo"];//实验室编号
                Global.TestUnitName = ConfigurationManager.AppSettings["UpDetectUnit"];//检测点名称
                Global.NickName = ConfigurationManager.AppSettings["NickName"];//负责人
                Global.PhotoNum = ConfigurationManager.AppSettings["photos"]; //手机号
