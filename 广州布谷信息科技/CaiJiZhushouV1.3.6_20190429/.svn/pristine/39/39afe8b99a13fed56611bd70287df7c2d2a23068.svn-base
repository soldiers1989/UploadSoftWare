...
namespace WorkstationUI.function
{
    public partial class ucStatiscal : UserControl
    {
        ...
        private void ucStatiscal_Load(object sender, EventArgs e)
        {
            ...
            {
                dy.savediary(DateTime.Now.ToString(), "进入统计分析错误："+ex.Message, "错误");
                MessageBox.Show(ex.Message,"统计分析");
            }
        ...
        private void dTPEnd_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                dy.savediary(DateTime.Now.ToString(), "进入统计分析错误查询：" + ex.Message, "错误");
                MessageBox.Show(ex.Message ,"统计分析查询");
            }
        }
        //获取检测项目到combox
        ...
        private void cmbResult_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            {
                dy.savediary(DateTime.Now.ToString(), "进入统计分析结论查询：" + ex.Message, "错误");
                MessageBox.Show(ex.Message ,"统计分析结论查询");
            }
        }
        ...
        private void cmbTestItem_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            {
                dy.savediary(DateTime.Now.ToString(), "检测项目查询错误：" + ex.Message, "错误");
        ...
        private void cmbSample_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            {
                dy.savediary(DateTime.Now.ToString(), "样品查询错误：" + ex.Message, "错误");
        ...
        private void dTStart_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                dy.savediary(DateTime.Now.ToString(), "日期查询错误：" + ex.Message, "错误");
