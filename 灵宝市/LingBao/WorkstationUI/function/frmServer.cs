    ...
    public partial class frmServer : Form
    {
        ...
        private void BtnCommunicate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else if (txtMachineSerial.Text.Trim().Length == 0)
                {
                    MessageBox.Show("设备ID不能为空！", "提示", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    BtnCommunicate.Enabled = true;
                    return;
                }
                ...
                Global.MachineSerialCode = txtMachineSerial.Text.Trim();//设备ID
