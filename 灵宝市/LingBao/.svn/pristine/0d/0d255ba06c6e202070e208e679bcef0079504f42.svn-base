    ...
    {   
        ...
        public int LoadInData(clsSaveResult result, out string errMsg)
        {
            ...
            try
            {
                ...
                _strBd.Append("Xiguangdu,HoleNum)VALUES(");
        ...
        public void RepairResult(clsUpdateData SR,int wID, out string errMsg)
        {
            ...
            try
            {
                ...
                _strBd.AppendFormat("SampleTime='{0}',", SR.GetSampTime.Replace('/','-'));
                ...
                _strBd.AppendFormat("CheckTime='{0}'", SR.ChkTime);
                ...
                _strBd.AppendFormat("ProductDatetime='{0}',", SR.ProductDate.Replace('/', '-'));
                _strBd.AppendFormat("SendTestDate='{0}',", SR.SendDate.Replace('/', '-'));
        ...
        public DataTable ExportExcel(string whereSql, string orderBySql, out string errMsg)
        {
            ...
            try
            {
                ...
                sb.Append("IsUpload as 已上传,SampleCode as 样品编号,MachineNum as 仪器编号,ProductPlace as 产地");
