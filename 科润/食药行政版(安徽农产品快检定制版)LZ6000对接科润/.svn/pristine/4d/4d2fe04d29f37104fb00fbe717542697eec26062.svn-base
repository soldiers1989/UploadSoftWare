...
namespace FoodClient
{
    ...
    /// </summary>
    public class frmCheckedComSelect : TitleBarBase
    {
        ...
        private void frmCheckedComSelect_Load(object sender, System.EventArgs e)
        {
            ...
            if (tag.Equals("Checked"))
            {
                ...
                if (!ShareOption.AllowHandInputCheckUint)//如果不是手工录入被检单位
                {
                    if (ShareOption.SystemVersion == ShareOption.LocalBaseVersion)//行政版
                    {
                        ...
                        dtblDistrict = districtBll.GetAsDataTable("SysCode LIKE '" + districtCode + "_%'", "SysCode", 0);
                        ...
                        {
							code = dtblDistrict.Rows[0]["SysCode"].ToString();
							bool detailed = clsDistrictOpr.DistrictIsMX(code);

                            for (int i = 0; i < dtblDistrict.Rows.Count; i++)
                            {
								code = dtblDistrict.Rows[i]["SysCode"].ToString();   //code="001001"
            ...
            else  //生产单位
            {
                ...
                dtblDistrict = companyBll.GetAsDataTable("IsLock=false And IsReadOnly=true And TSign='本地增' ", "SysCode", 3);
        ...
        private void getSubCompanyKindNode(string sysCode, string districtCode, ref TreeNode theNode,DataTable companies)
		{  //sysCode="001"  districtCode="001001"
			...
			//else //如果没有二级单位类别
            {
				...
				DataView companyView = companies.DefaultView;
				companyView.RowFilter = sqlWhere;
				dtblCompany = companyView.ToTable();
               // dtblCompany = companyBll.GetAsDataTable(sqlWhere, "SysCode", 1);
        ...
        private void InitializeComponent()
        {
			...
			// btnLocation
			// 
			this.btnLocation.Location = new System.Drawing.Point(241, 33);
			...
			// txtName
			// 
			this.txtName.Location = new System.Drawing.Point(105, 35);
			...
			this.btnCancel.Location = new System.Drawing.Point(321, 373);
			...
			// btnOK
			// 
			this.btnOK.Location = new System.Drawing.Point(233, 373);
			...
			this.treeView1.Location = new System.Drawing.Point(22, 61);
			...
			// btnNext
			// 
			this.btnNext.Location = new System.Drawing.Point(321, 33);
