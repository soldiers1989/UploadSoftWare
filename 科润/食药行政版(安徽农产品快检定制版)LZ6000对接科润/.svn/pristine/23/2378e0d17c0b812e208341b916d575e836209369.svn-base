...
namespace FoodClient.AnHui
{
    public class Global
    {
        ...
        public static class AnHuiInterface
        {
            ...
            public static string ServerAddr = ConfigurationManager.AppSettings["HeFei_uploadUrl"];//服务器地址
            public static string Chkdanwei = ConfigurationManager.AppSettings["AbHui_DetectUnit"];//检测单位
            public static string Chkbianhao = ConfigurationManager.AppSettings["AnHui_UnitID"];//检测单位编号
            public static string UploadType = ConfigurationManager.AppSettings["AnHui_UpType"];//上传类型
            public static string SheBeiID = ConfigurationManager.AppSettings["AnHui_SheBeiID"];//设备编号
