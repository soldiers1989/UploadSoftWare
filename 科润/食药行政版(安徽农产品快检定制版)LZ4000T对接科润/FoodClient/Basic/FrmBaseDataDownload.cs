...
namespace FoodClient
{
    ...
    public partial class FrmBaseDataDownload : TitleBarBase
    {
        ...
        private void FrmBaseDataDownload_Load(object sender, EventArgs e)
        {
            ...
            txt_ChkUnit.Text  = Global.AnHuiInterface.Chkdanwei;
            txt_UnitID.Text = Global.AnHuiInterface.Chkbianhao;
            cmbUpType.Text = Global.AnHuiInterface.UploadType;
            txtMachineID.Text = Global.AnHuiInterface.SheBeiID;
        ...
        {                        
            ...
            string chkunit = txt_ChkUnit.Text.Trim();
            string unitID = txt_UnitID.Text.Trim();
            string uptype = cmbUpType.Text.Trim();
            string shebeiID = txtMachineID.Text.Trim();
            ...
            Global.AnHuiInterface.Chkdanwei = chkunit;
            Global.AnHuiInterface.Chkbianhao = unitID;
            Global.AnHuiInterface.UploadType = uptype;
            Global.AnHuiInterface.SheBeiID = shebeiID;
            ...
            //cfa.Save();
            //检测单位
            str = ConfigurationManager.AppSettings["AbHui_DetectUnit"];
            if (str != null)
                cfa.AppSettings.Settings["AbHui_DetectUnit"].Value = Global.AnHuiInterface.Chkdanwei;
            else
                cfa.AppSettings.Settings.Add("AbHui_DetectUnit", Global.AnHuiInterface.Chkdanwei);
            cfa.Save();
            //检测单位编号
            str = ConfigurationManager.AppSettings["AnHui_UnitID"];
            if (str != null)
                cfa.AppSettings.Settings["AnHui_UnitID"].Value = Global.AnHuiInterface.Chkbianhao;
            else
                cfa.AppSettings.Settings.Add("AnHui_UnitID", Global.AnHuiInterface.Chkbianhao);
            cfa.Save();
            //上传类型
            str = ConfigurationManager.AppSettings["AnHui_UpType"];
            if (str != null)
                cfa.AppSettings.Settings["AnHui_UpType"].Value = Global.AnHuiInterface.UploadType;
            else
                cfa.AppSettings.Settings.Add("AnHui_UpType", Global.AnHuiInterface.UploadType);
            cfa.Save();
            //设备ID
            str = ConfigurationManager.AppSettings["AnHui_SheBeiID"];
            if (str != null)
                cfa.AppSettings.Settings["AnHui_SheBeiID"].Value = Global.AnHuiInterface.SheBeiID;
            else
                cfa.AppSettings.Settings.Add("AnHui_SheBeiID", Global.AnHuiInterface.SheBeiID);
            cfa.Save();
