...
namespace AIO
{
    ...
    public partial class SettingsWindow : Window
    {
            ...
            public void UIHandleMessage(Message msg)
            {
                switch (msg.what)
                {
                    ...
                    case MsgCode.MSG_REGISTE_MACHINE:
                        ...
                        {
                            wnd.bun();
                            MessageBox.Show(msg.responseInfo);
        ...
        private void Btn_autoUpdater_Click(object sender, RoutedEventArgs e)
        {
            ...
            FileUtils.KLog(sb.ToString(), "接收", 13);
            ...
            if (Mresult.msg == "操作成功" && Mresult.success == true)
            {
                ...
                durl = dr.url_path;
                if (MessageBox.Show("检测有版本更新，版本号为： " + dr.version + ", 是否下载更新", "系统提示", MessageBoxButton.YesNoCancel, MessageBoxImage.Question) == MessageBoxResult.Yes)
                {
                    try
                    {
