            ...
            try
            {
                ...
                if (SampleName != string.Empty && str != "NA" && !str.Contains("*"))
                {
                    ...
                    else
                    {
                        ...
                        string fparentid = "";
                        //查询出样品的父ID
                        sb.AppendFormat("food_name='{0}'", SampleName);
                        ...
                        if (dt != null && dt.Rows.Count > 0)
                        {
                            ...
                            {
                                sb.Length = 0;
                                sb.AppendFormat(" d.detect_item_name='{0}' and s.sid=d.standard_id", ItemName);
