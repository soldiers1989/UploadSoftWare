        ...
        public DataTable GetSample(string wheresql, string orderby, int type, out string errMsg)
        {
            ...
            try
            {
                if (type == 1)
                {
                    ...
                    //sql.Append(" foodname,d.detect_item_name as itemname,sd.std_code as standard from SampleStandard std ,foodlist f,DetectItem ");
                    //sql.Append("d,StandardList sd where f.fid=std.food_id and d.cid=std.item_id and sd.sid=d.standard_id");
                }
        ...
        public DataTable GetItem(string wheresql, string orderby, int type, out string errMsg)
        {
            ...
            try
            {
                if (type == 1)
                {
                    ...
                    //sql.Append("select d.cid,d.detect_item_name,d.detect_item_typeid,d.standard_id,d.detect_sign,d.detect_value,d.detect_value_unit,d.checked");
                    //sql.Append(",d.cimonitor_level,d.remark,d.delete_flag,d.create_by,d.create_date,d.update_by,d.update_date,d.t_id,d.t_item_name,d.t_item_name");
                    //sql.Append(",d.t_sorting,d.t_remark,d.t_delete_flag,d.t_create_by,d.t_create_date,d.t_update_by,d.t_update_date,s.std_code as standard  from DetectItem d,StandardList s where s.sid=d.standard_id");
                }
                if (!wheresql.Equals(string.Empty))
                {
                    sql.Append(" WHERE ");
