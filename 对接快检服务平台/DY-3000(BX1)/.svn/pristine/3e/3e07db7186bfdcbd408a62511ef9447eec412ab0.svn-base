                    ...
                    if (_contrast)
                    {
                        ...
                        for (int i = 0; i < Global.deviceHole.HoleCount; ++i)
                        {
                            if (_use[i] && i != contrastIdx)
                            {
                                ...
                                _CheckValue[(num > 0 ? (i - num) : i), 21] = _item.Hole[i].tID;//抽样任务ID，上传查询数据
                                _CheckValue[(num > 0 ? (i - num) : i), 22] = _item.Hole[i].Operator;//经营户，上传查询数据
                                _CheckValue[(num > 0 ? (i - num) : i), 23] = _item.Hole[i].OperatorID ;//
