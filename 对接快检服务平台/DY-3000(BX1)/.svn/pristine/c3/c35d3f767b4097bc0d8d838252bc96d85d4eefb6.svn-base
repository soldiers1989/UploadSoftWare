        ...
        public DataTable GetSamplestd(string wheresql, string orderby, int type, out string errMsg)
        {
            ...
            try
            {
                if (type == 1)
                {
                    ...
                    //sb.Append("d,StandardList sd where f.fid=std.food_id and d.cid=std.item_id and sd.sid=d.standard_id and std.checked='1' and std.delete_flag='0' and f.checked='1' and f.delete_flag='0' ");
                    //sb.Append("and d.checked='1' and d.delete_flag='0' and sd.delete_flag='0' ");
        ...
        public DataTable GetItem(string wheresql, string orderby, int type, out string errMsg)
        {
            ...
            try
            {
                if (type == 1)
                {
                    ...
                    //sb.Append(",d.t_sorting,d.t_remark,d.t_delete_flag,d.t_create_by,d.t_create_date,d.t_update_by,d.t_update_date,s.std_code as standard  from DetectItem d,StandardList s where s.sid=d.standard_id and d.delete_flag='0' and s.delete_flag='0' and d.checked='1'");
