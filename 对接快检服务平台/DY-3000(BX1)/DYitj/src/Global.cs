...
namespace AIO
{
    public class Global
    {
        ...
        /// 新的验证连接地址有效性方法
        /// </summary>
        public static string pointNum = string.Empty, ponitName = string.Empty, pointType = string.Empty, orgNum = string.Empty, orgName = string.Empty, userUUID = string.Empty, orgID = string.Empty;
        /// <summary>
        /// 是否调整项目坐标
        /// </summary>
        ...
        /// 手动测试
        /// </summary>
        public static bool ManuTest = true;
        /// <summary>
        /// 检测样品数据
        /// </summary>
        ...
        public static string Tasktile = "";
        public static string TaskID = "";
        public static string d_sample = "";
