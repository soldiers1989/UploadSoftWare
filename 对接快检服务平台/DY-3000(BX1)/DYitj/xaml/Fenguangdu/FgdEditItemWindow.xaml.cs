...
namespace AIO
{
    ...
    public partial class FgdEditItemWindow : Window
    {
            ...
            try
            {
                ...
                if (null != _item)
                {
                    ...
                    else if (1 == _MethodToIndex[_item.Method])
                    {
                        ...
                        if (Global.InterfaceType.Equals("AH")) Btn_CalculatedCurve.Visibility = Visibility.Visible;
        ...
        private void ComboBoxMethod_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            _isUpdate = true;
            //标准曲线法
            if (Global.InterfaceType.Equals("AH")) Btn_CalculatedCurve.Visibility = ComboBoxMethod.SelectedIndex == 1 ? Visibility.Visible : Visibility.Collapsed;
        }
        ...
        private void Btn_CalculatedCurve_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                WaveIndex = ComboBoxWave.SelectedIndex
            };
            window.ShowDialog();
