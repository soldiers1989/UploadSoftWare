...
namespace AIO.xaml.Main
{
    ...
    public partial class DataManagementWindow : Window
    {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void Btn_DetectItem_Click(object sender, RoutedEventArgs e)
        {
            KJItemshow window = new KJItemshow();
            window.ShowDialog();
        }
        /// <summary>
        /// 样品下载
        ...
        {
            Foodlistwindow window = new Foodlistwindow();
            window.ShowDialog();
        }
        /// <summary>
        /// 检测项目样品标准下载
        ...
        {
            SampleItemStandard window = new SampleItemStandard();
            window.ShowDialog();
        }
        /// <summary>
        /// 国家检测标准下载
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void BtnStandardMage_Click(object sender, RoutedEventArgs e)
        {
