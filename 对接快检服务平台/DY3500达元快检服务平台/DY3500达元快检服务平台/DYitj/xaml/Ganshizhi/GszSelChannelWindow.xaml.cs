...
namespace AIO
{
    ...
    {
        public KJFWGHXItem _item = null;
        public DYGSZItemPara _itemo = null;
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            if (Global.ManuTest == true)
            {
                ...
                labelTitle.Content ="干化学模块  "+ _item.Name ;
                oShowAllChannel();
            }
            else
            {
                ...
                Global.iscanzhao = false;
                labelTitle.Content = "干化学模块  " + _item.item ;
        ...
        private void ButtonNext_Click(object sender, RoutedEventArgs e)
        {
            ...
            // 是否选择了检测孔
            int i = 0;
            for (i = 0; i < Global.deviceHole.SxtCount; ++i)//Global.deviceHole.SxtCount
            {
                if (Global.ManuTest == true)
                {
                    if (_item.Hole[i].Use)
        ...
        {
            for (int i = 0; i < Global.deviceHole.SxtCount; ++i)//Global.deviceHole.SxtCount
            {
                UIElement element = GenerateChlBriefLayout(i, string.Empty);
                WrapPanelChannel.Children.Add(element);
                if (i < shole)
