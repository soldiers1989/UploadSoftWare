    ...
    public partial class DataManagementWindow : Window
    {
        ...
        private void btnUpdateData_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (MessageBox.Show("是否更新基础数据", "提示", MessageBoxButton.YesNo, MessageBoxImage.Question) == MessageBoxResult.Yes)
                {
        ...
        private void downdata(Action<int> percent)
        {
            ...
            try
            {
                ...
                #region 国家标准更新
                _bll.DeleteBaseData("", "", 9, out err);//删除原来所有数据
                ...
                #region 法律法规更新
                _bll.DeleteBaseData("", "", 8, out err);//删除原来所有数据
                ...
                _bll.DeleteBaseData("", "", 1, out err);//删除原来所有数据
                ...
                if (Citemlist.Length > 0)
                {
                    ...
                    if (obj != null && obj.deviceItem.Count > 0)
                    {
                        sp = 0;
                        p = (float)100 / (float)obj.deviceItem.Count;
                ...
                FileUtils.KLog(sb.ToString(), "接收", 7);
                ...
                FileUtils.KLog(sb.ToString(), "接收", 8);
                if (stype.Length > 0)
                {
                    ...
                    {
                        sp = 0;
                        p = (float)100 / (float)obj.food.Count;
                ...
                if (rtndata.Length > 0)
                {
                    ...
                    {
                        sp = 0;
                        p = (float)100 / (float)regu.regulatory.Count;
                ...
                if (rtndata.Length > 0)
                {
                    ...
                    {
                        sp = 0;
                        p = (float)100 / (float)regu.business.Count;
                ...
                if (rtndata.Length > 0)
                {
                    ...
                    {
                        sp = 0;
                        p = (float)100 / (float)regu.personnel.Count;
