...
namespace AIO.xaml.Dialog
{
    ...
    public partial class SearchCompanyWindow : Window
    {
        ...
        private void SearchCompany_Click(object sender, RoutedEventArgs e)
        {
            //Search();
            sb.Length = 0;
            sb.AppendFormat(" r.reg_name like '%{0}%' and r.checked='1' and r.delete_flag='0' and depart_id='{1}'", textBoxName.Text.Trim(), Global.depart_id);
        ...
        private void Search()
        {
            ...
            {
                DataTable dt = _company.GetAsDataTable(" r.checked='1' and r.delete_flag='0' and depart_id='" + Global.depart_id+"'", string.Empty, 13);
