        ...
        public DataTable GetAsDataTable(string whereSql, string orderBySql, int type)
        {
            ...
            try
            {
                ...
                else if (type == 5)
                {
                    ...
                    strB.Append("select IIF(s.use_default = '0',s.detect_sign,item.detect_sign) as detect_sign,IIF(s.use_default = '0',s.detect_value_unit,item.detect_value_unit) as detect_value_unit,IIF(s.use_default = '0',s.detect_value,item.detect_value) as detect_value,");
                    strB.Append("f.food_name,item.detect_item_name,item.standard_id from SampleStandard s,DetectItem item,foodlist f");
                ...
                {
                    strB.Append("select d.standard_id as standard_id,d.detect_sign as detect_sign,d.detect_value as detect_value,d.detect_value_unit as detect_value_unit,s.std_code as std_code from DetectItem d,StandardList s ");
                }
                else if (type == 10)
                {
                    strB.Append("select * from StandardList ");
                }
