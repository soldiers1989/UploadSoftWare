        ...
        public DataTable GetMachineItem(string wheresql, string orderby, int type, out string errMsg)
        {
            ...
            try
            {
                ...
                else if (type == 2)
                {
                    ...
                    sb.Append("m.yang_min,m.yang_max,m.yinT,m.yangT,m.absX,m.ctAbsX,m.division,m.parameter,m.reserved1,m.reserved2,m.reserved3,m.stdA0,m.stdA1,m.stdA2,m.stdA3,");
                    sb.Append("m.stdB0,m.stdB1,m.stdB2,m.stdB3,d.detect_item_name as itemname from MachineItem m,DetectItem d where d.cid=m.item_id and d.checked='1' and d.delete_flag='0' and m.delete_flag='0'");
                }
        ...
        public DataTable GetSamplestd(string wheresql, string orderby, int type, out string errMsg)
        {
            ...
            try
            {
                if (type == 1)
                {
                    ...
                    //sb.Append("d,StandardList sd where f.fid=std.food_id and d.cid=std.item_id and sd.sid=d.standard_id and std.checked='1' and std.delete_flag='0' ");
                    //sb.Append(" and f.checked='1' and f.delete_flag='0' and d.checked='1' and d.delete_flag='0' and sd.delete_flag='0' ");
                    sb.Append("select std.food_id,std.item_id,std.detect_sign,std.detect_value,std.detect_value_unit,std.update_date,f.food_name as");
                    sb.Append(" foodname,d.detect_item_name as itemname from SampleStandard std ,foodlist f,DetectItem ");
                    sb.Append("d where f.fid=std.food_id and d.cid=std.item_id and std.checked='1' and std.delete_flag='0' and f.checked='1' and f.delete_flag='0' ");
                    sb.Append("and d.checked='1' and d.delete_flag='0' ");
                }
                if (!wheresql.Equals(string.Empty))
                {
                    //sb.Append(" WHERE ");
        ...
        public DataTable GetItem(string wheresql, string orderby, int type, out string errMsg)
        {
            ...
            try
            {
                if (type == 1)
                {
                    ...
                    sb.Append("select d.cid,d.detect_item_name,d.detect_item_typeid,d.standard_id,d.detect_sign,d.detect_value,d.detect_value_unit,d.checked");
                    sb.Append(",d.cimonitor_level,d.remark,d.delete_flag,d.create_by,d.create_date,d.update_by,d.update_date,d.t_id,d.t_item_name,d.t_item_name");
                    sb.Append(",d.t_sorting,d.t_remark,d.t_delete_flag,d.t_create_by,d.t_create_date,d.t_update_by,d.t_update_date  from DetectItem d where d.delete_flag='0' and d.checked='1'");
