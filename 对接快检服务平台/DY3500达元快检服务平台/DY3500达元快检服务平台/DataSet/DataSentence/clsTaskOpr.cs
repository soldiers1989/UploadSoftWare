    ...
    public class clsTaskOpr
    {
        ...
        public DataTable GetSampleByNameOrCode(string SampleName, string Name, bool IsPreciseQuery, bool IsFirst, int type)
        {
            ...
            try
            {
                ...
                else if (type == 3)
                {
                    ...
                    //{
                    //    sb.Append("select d.cid,d.detect_item_name,s.food_id,f.food_name,sd.std_name,s.detect_value,s.detect_value_unit from DetectItem d,foodlist f,SampleStandard s,StandardList sd ");
                    //    sb.AppendFormat("where d.detect_item_name='{0}' and s.item_id=d.cid and s.food_id=f.fid and sd.sid=d.standard_id ", Name);
                    //    sb.Append("and d.checked='1' and d.delete_flag='0' and f.checked='1' and f.delete_flag='0' and s.checked='1' and s.delete_flag='0' and sd.delete_flag='0' ");
                    //}
                    //else if (!SampleName.Equals(""))
                    //{
                    //    sb.Append("select d.cid,d.detect_item_name,s.food_id,f.food_name,sd.std_name,s.detect_value,s.detect_value_unit from DetectItem d,foodlist f,SampleStandard s,StandardList sd ");
                    //    sb.AppendFormat("where d.detect_item_name='{0}' and s.item_id=d.cid and s.food_id=f.fid and sd.sid=d.standard_id ", Name);
                    //    sb.AppendFormat("and d.checked='1' and d.delete_flag='0' and f.checked='1' and f.delete_flag='0' and s.checked='1' and s.delete_flag='0' and sd.delete_flag='0' and f.food_name like '%{0}%' ", SampleName);
                    //}
                    ...
                    sb.AppendFormat("select f.food_name as foodname,d.detect_item_name as itemname,s.detect_value,s.detect_sign from DetectItem d,SampleStandard  s ,foodlist f where f.fid=s.food_id and s.item_id=d.cid and d.detect_item_name ='{0}' and s.checked='1' and s.delete_flag='0' and d.checked='1' and d.delete_flag='0' and f.checked='1' and f.delete_flag='0'", Name);
                }
                else if (type == 4)
                {
                    sb.AppendFormat("select f.food_name as foodname,d.detect_item_name as itemname,s.detect_value,s.detect_sign from DetectItem d,SampleStandard  s ,foodlist f where f.fid=s.food_id and s.item_id=d.cid and d.detect_item_name = '{0}' and s.checked='1' and s.delete_flag='0' and d.checked='1' and d.delete_flag='0' and f.checked='1' and f.delete_flag='0' and f.food_name like '%{1}%'", Name, SampleName);
        ...
        public DataTable GetCheckItem(string whereSql, string orderBySql, int type)
        {
            ...
            try
            {
                ...
                if (type == 0)
                {
                    ...
                    sb.Append(",division,parameter,trailingEdgeC,trailingEdgeT,suspiciousMin,suspiciousMax,reserved1,reserved2,reserved3,reserved4,reserved5,m.remark,m.delete_flag,m.create_by,m.create_date,m.update_by,m.update_date,d.detect_item_name as item,SaveTime,RefDeltaA FROM MachineItem m,DetectItem d where d.cid=item_id ");
                    sb.Append("and d.checked='1' and d.delete_flag='0' and m.delete_flag='0' and ");
        ...
        public DataTable GetCompany(string whereSql, string orderBySql, int type,out string errMsg)
        {
            ...
            try
            {
                ...
                {
                    sb.Append("select b.bid,b.ope_shop_name,b.ope_shop_code,r.reg_name,b.ope_name from business b,regulardata r  ");
                }
                else if (type == 2)
                {
                ...
                {
                    sb.Append("select * from regulardata ");
                }
        ...
        public string  DeleteTast(string where,  out string errMsg)
        {
            ...
            {
                sb.Length = 0;
                sb.AppendFormat("DELETE FROM KTask ");
        ...
        public int UpdateBarTask(string where, string data,int type, out string errMsg)
        {
            errMsg = string.Empty;
            int rtn = 0;
            try
            {
                ...
                if (type == 1)
                {
                    sb.AppendFormat("UPDATE BarTask SET mokuai='{0}'", data);
                    sb.AppendFormat(" where bid='{0}'", where);
                }
        ...
        public int InsertBarTask(BarTask model, out string errMsg)
        {
            errMsg = string.Empty;
            int rtn = 0;
            try
            {
                sb.Length = 0;
                sb.Append("INSERT INTO BarTask (bid,bagCode,foodName,itemName,mokuai,IsTest,getSampleTime,InBarCode)VALUES(");
                sb.AppendFormat("'{0}',",model.id  );
                sb.AppendFormat("'{0}',", model.bagCode );
                sb.AppendFormat("'{0}',", model.foodName );
                sb.AppendFormat("'{0}',", model.itemName );
                sb.AppendFormat("'{0}',", model.mokuai );
                sb.AppendFormat("'{0}',", model.IsTest );
                sb.AppendFormat("'{0}',", model.getSampleTime );
                sb.AppendFormat("'{0}')", model.InBarCode );
        ...
        /// <param name="?"></param>
        /// <returns></returns>
        public DataTable GetBarTask(string where, string order,int type, out string errMsg)
        {
            errMsg = string.Empty;
            DataTable dtbl = null;
            ...
            try
            {
                ...
                string[] cmd = new string[1] { sb.ToString() };
                string[] names = new string[1] { "BarTask" };

                dtbl = DataBase.GetDataSet(cmd, names, out errMsg).Tables["BarTask"];
                sb.Length = 0;
        ...
        /// <param name="errMsg"></param>
        /// <returns></returns>
        public int DeleteBarTask(string where, string order, int type, out string errMsg)
        {
            errMsg = string.Empty;
            int rtn = 0;
            try
