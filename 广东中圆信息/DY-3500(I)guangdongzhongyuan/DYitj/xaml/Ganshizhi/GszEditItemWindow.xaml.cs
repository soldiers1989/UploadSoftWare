                ...
                if (null != _item)
                {
                    ...
                    for (int method = 0; method < 2; ++method)
                    {
                        if (0 == method)
                        {
                            ...
                            //ComboBoxDXRGBSelMinus.SelectedIndex = _item.dx.Min;
                            ...
                            txtMin1.Text = _item.dx.Min[0].ToString();
                            txtMin2.Text = _item.dx.Min[1].ToString();
                            txtMax1.Text = _item.dx.Max[0].ToString();
                            txtMax2.Text = _item.dx.Max[1].ToString();
                        }
                        else if (1 == method)
                        {
            ...
            try
            {
                if (check())
                {
                    ...
                    if (0 == _item.Method)
                    {
                        ...
                        //_item.dx.Min = ComboBoxDXRGBSelMinus.SelectedIndex;
                        ...
                        double.TryParse(txtMin1.Text.Trim(), out _item.dx.Min[0]);
                        double.TryParse(txtMin2.Text.Trim(), out _item.dx.Min[1]);
                        double.TryParse(txtMax1.Text.Trim(), out _item.dx.Max[0]);
                        double.TryParse(txtMax2.Text.Trim(), out _item.dx.Max[1]);
                    }
                    ...
                    _item.dx.DeltaA = new double[Global.deviceHole.SxtCount];
