    ...
    public class tlsttResultSecondOpr
    {
        ...
        public int Insert(tlsTtResultSecond model, out string errMsg)
        {
            ...
            try
            {
                ...
                sql.Append(" CheckPlanCode,Hole,CheckMethod,APRACategory,CheckType,DateManufacture,ContrastValue,DeviceId,SampleId,ProduceCompany,SysCode,SAMPLEUUID) ");
                sql.Append(" VALUES(");
                ...
                sql.AppendFormat("'{0}')", model.SAMPLEUUID);
                DataBase.ExecuteCommand(sql.ToString(), out errMsg);
                sql.Length = 0;
