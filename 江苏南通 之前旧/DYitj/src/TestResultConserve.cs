            ...
            try
            {
                ...
                for (int i = 0; i < result.GetLength(0); i++)
                {
                    if (!result[i, 4].ToString().Contains("NA") && !result[i, 4].ToString().Contains("*") && !string.IsNullOrEmpty(result[i, 4]))
                    {
                        ...
                        _model.SAMPLEUUID = Global._selSampleID;
                        ...
                        testtask.SampleID = Global._selSampleID;
                        testtask.SampleName = Global._selSamplename;
                        testtask.ItemName = Global._itemname;
                        testtask.tasktime = Global._tasktime;
            ...
            try
            {
                ...
                for (int i = 0; i < forLenght; i++)
                {
                    if (!result[i, 4].ToString().Contains("NA") && !result[i, 4].ToString().Contains("*") && !string.IsNullOrEmpty(result[i, 4]))
                    {
                        ...
                        _model.SAMPLEUUID = Global._selSampleID;//result[i, 16];//南通样品编号
