...
namespace AIO
{
    ...
    public class Global
    {
        ...
        /// 昆山 - token
        /// </summary>
        public static string KsTokenNo = string.Empty;

        /// <summary>
        /// 昆山 - 用户名
        /// </summary>
        public static string KsUser = string.Empty;

        /// <summary>
        /// 昆山 - 密码
        /// </summary>
        public static string KsPwd = string.Empty;

        /// <summary>
        /// 昆山 - 接入单位名称
        /// </summary>
        public static string KsMarketName = string.Empty;

        /// <summary>
        /// 昆山 - 接入单位编号
        /// </summary>
        public static string KsMarketCode = string.Empty;

        /// <summary>
        /// 昆山 - 检测设备编号
        /// </summary>
        public static string KsJCSN = string.Empty;

        /// <summary>
        /// 昆山 - 软件版本：0市场,  1.超市  2.检测机构
        /// </summary>
        public static string KsVersion = string.Empty;
        /// <summary>
        /// 昆山 - 分局版本 存储市场信息
        /// </summary>
        public static string KsMarketInfo = string.Empty;
        ...
        public static bool UploadCheck(Window wnd, out string Info)
        {
            ...
            if (Global.KsUser.Length == 0 || Global.KsPwd.Length == 0 ||
                Global.KsMarketName.Length == 0 || Global.KsMarketCode.Length == 0 || Global.KsJCSN.Length == 0)
            {
                MessageBox.Show(wnd, "检测到数据上传所需的信息不完整，请前往[设置]界面进行设置！", "系统提示", MessageBoxButton.OK, MessageBoxImage.Error);
                Info = "服务器链接信息不完善";
                return false;
            }
            ...
            if (Global.KsTokenNo.Length == 0)
            {
                ...
                {
                    MessageBox.Show(wnd, "令牌获取失败，请核对服务器链接信息是否正确！", "系统提示", MessageBoxButton.OK, MessageBoxImage.Error);
                    Info = "令牌获取失败";
                    return false;
                }
            }
        ...
        {
            return DateTime.Now.ToString("fff") + GenerateAlphas();
        }
