...
namespace AIO
{
    public class MsgCode
    {
        ...
        /// 昆山项目获取token信息
        /// </summary>
        //public const int KS_GETTOKEN = 10039;
        /// <summary>
        /// 昆山项目通讯测试，并获取营业执照信息
        /// </summary>
        public const int KS_QUERYMARKET = 10040;
        /// <summary>
        /// 昆山分局版本 获取单位主体信息
        /// </summary>
        public const int KS_GetAreaMarket = 10044;
        /// <summary>
        /// 根据单位主体信息获取经营户
        /// </summary>
        public const int KS_QuerySignContactByAM = 10045;
        /// <summary>
        /// 昆山经营户下载
        /// </summary>
        public const int KS_QuerySignContact = 10041;
        /// <summary>
        /// 昆山检测项目下载
        /// </summary>
        public const int KS_QueryCheckItem = 10042;
        /// <summary>
        /// 昆山检测品种下载
        /// </summary>
        public const int KS_QuerySalesItem = 10043;
    }
}
