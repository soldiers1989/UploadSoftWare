...
namespace DYSeriesDataSet
{
    public class tlsTtResultSecond
    {
        ...
        /// 昆山 - 经营户身份证号码
        /// </summary>
        public string DABH = string.Empty;

        /// <summary>
        /// 昆山 - 经营户摊位编号
        /// </summary>
        public string PositionNo = string.Empty;

        /// <summary>
        /// 昆山 - 经营户姓名
        /// </summary>
        public string DABHName = string.Empty;

        /// <summary>
        /// 昆山 - 抽检的品种编码
        /// </summary>
        public string SubItemCode = string.Empty;

        /// <summary>
        /// 昆山 - 抽检的品种名称
        /// </summary>
        public string SubItemName = string.Empty;

        /// <summary>
        /// 昆山 - 抽检项目大类编号
        /// </summary>
        public string QuickCheckItemCode = string.Empty;

        /// <summary>
        /// 昆山 - 抽检项目小类编号
        /// </summary>
        public string QuickCheckSubItemCode = string.Empty;
        #endregion
    }
}
