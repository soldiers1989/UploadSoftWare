    ...
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                Global.DetectUnitNo = ConfigurationManager.AppSettings["UpDetectUnitNo"];//检测单位
                ...
                Global.KSVsion  = ConfigurationManager.AppSettings["MarketType"];
        ...
        private void labelclose_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dr == DialogResult.Yes)
                {
                    ...
                    if(Global.Token !="")
                    {
                        KunShanEntity.LogoutTokenRequest.Request quxiao = new KunShanEntity.LogoutTokenRequest.Request();
                        KunShanEntity.LogoutTokenRequest.webService webks = new KunShanEntity.LogoutTokenRequest.webService();
                        quxiao.tokenNo = Global.Token;
                        webks.request = quxiao;
                        string uploadXml = XmlHelper.EntityToXml<KunShanEntity.LogoutTokenRequest.webService>(webks);
                        com.szscgl.ncp.sDataInfrace webserver = new com.szscgl.ncp.sDataInfrace();
                        string rtn= webserver.checkOut(uploadXml);
