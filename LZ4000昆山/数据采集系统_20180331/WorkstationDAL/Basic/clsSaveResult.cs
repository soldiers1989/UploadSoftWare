...
namespace WorkstationDAL.Basic
{
    public class clsSaveResult
    {
        ...
        private string _CheckItemSmall = "";
        /// <summary>
        /// 检测项目小类
        /// </summary>
        public string CheckItemSmall
        {
            get
            {
                return _CheckItemSmall;
            }
            set
            {
                _CheckItemSmall = value;
            }
        ...
        private string _detectunitNo = string.Empty;
        /// <summary>
        /// 检测单位编号
        /// </summary>
