    ...
    public partial class frmQueryModifi : Form
    {
        ...
        private void frmQueryModifi_Load(object sender, EventArgs e)
        {
            if (Global.AddItem.GetLength(0) > 0)
            {
                ...
                txtSampeCode.Text = Global.AddItem[0, 9];
                ...
                txtReTester.Text = Global.AddItem[0, 12];//复核人
                txtChkTime.Text = Global.AddItem[0, 14];
                txtcompanycode.Text = Global.AddItem[0, 15];
                txtopertor.Text = Global.AddItem[0, 17];
                txtSfzh.Text = Global.AddItem[0, 18];
                txtStallNum.Text = Global.AddItem[0, 19];
                txtJigouNum.Text = Global.AddItem[0, 24];
                txtBigItemCode.Text = Global.AddItem[0, 20];
                txtSamllItemcode.Text = Global.AddItem[0, 21];
                txtRetest.Text = Global.AddItem[0, 25];
                txtbeizhu.Text = Global.AddItem[0, 26];
                txtUnittype.Text = Global.AddItem[0, 16];
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try 
            {
                ...
                updata.ChkSampleCode = txtSampeCode.Text.Trim();
                updata.Retester = txtReTester.Text.Trim();
                updata.chkcompanycode = txtcompanycode.Text.Trim();
                updata.Shenfenzheng = txtSfzh.Text.Trim();
                updata.jigoubianhao = txtJigouNum.Text.Trim();
                updata.ChkitemCode = txtBigItemCode.Text.Trim();
                updata.ChkitemsmallCode = txtSamllItemcode.Text.Trim();
                updata.retest = txtRetest.Text.Trim();
                updata.beizhu = txtbeizhu.Text.Trim();
                updata.Jingyinghu = txtopertor.Text.Trim();
                updata.stallnum = txtStallNum.Text.Trim();
                updata.markettype = txtUnittype.Text.Trim();
