...
namespace DY.FoodClientLib
{
	...
	public class PrintOperation
	{
		...
		static public void PrintGrid(C1FlexGrid FlexGrid,string strHeader,string strFooter)
		{
			...
			//	FlexGrid.PrintGrid("",PrintGridFlags.ActualSize,"\t"+strHeader,strFooter);
				FlexGrid.PrintGrid("", PrintGridFlags.ActualSize, "\t" + strHeader, strFooter);
        ...
        static public void PreviewGrid(C1FlexGrid FlexGrid, string strHeader, string strFooter)
        {
            ...
            try
            {
				...
				PrintDocument documentSettings = FlexGrid.PrintParameters.PrintDocument;
				documentSettings.DefaultPageSettings.Landscape = true;
				documentSettings.DefaultPageSettings.Margins.Left = 10;
				documentSettings.DefaultPageSettings.Margins.Right = 10; 
				documentSettings.DefaultPageSettings.Margins.Top = 100;
				documentSettings.DefaultPageSettings.Margins.Bottom = 30;

                FlexGrid.PrintParameters.HeaderFont = new Font("宋体", 15, FontStyle.Bold);
				FlexGrid.PrintParameters.FooterFont = new Font("宋体", 10, FontStyle.Bold);

				//FlexGrid.PrintGrid("", PrintGridFlags.ShowPreviewDialog | PrintGridFlags.ShowPageSetupDialog,"\t" + strHeader, strFooter);
				FlexGrid.PrintGrid(strHeader, PrintGridFlags.ShowPreviewDialog, "\t" + strHeader, strFooter);
