...
namespace comModel
{
    ...
    public class IListDataSet
    {
        ...
        public static System.Data.DataSet ToDataSet(IList p_List)
        { 
        ...
        public static System.Data.DataSet ToDataSet<T>(IList<T> list)
        {
        ...
        public static System.Data.DataSet ToDataSet<T>(IList<T> p_List, params string[] p_PropertyName)
        {
        ...
        public static IList<T> DataSetToIList<T>(System.Data.DataSet p_DataSet, int p_TableIndex)
        {
        ...
        public static IList<T> DataSetToIList<T>(System.Data.DataSet p_DataSet, string p_TableName)
        {
            int _TableIndex = 0;
            if (p_DataSet == null || p_DataSet.Tables.Count < 0)
                return null;
