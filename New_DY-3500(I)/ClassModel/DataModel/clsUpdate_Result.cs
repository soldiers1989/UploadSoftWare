...
{
	/// <summary>
	/// clsUpdate_Result 的摘要说明。
	/// </summary>
	public class clsUpdate_Result
	{
		public clsUpdate_Result()
		{
			//
			// TODO: 在此处添加构造函数逻辑
			//
		...
		private string _CheckPlaceInfo;
		...
		private int _SampleBaseNum;
		private double _SampleNum;
		...
		public string CheckPlaceInfo
		{
			set
			{
				_CheckPlaceInfo=value;
			}
			get
			{
				return _CheckPlaceInfo;
			}		
		}
		...
		public string CheckedCompanyInfo
		{
			set
			{
				_CheckedCompanyInfo=value;
			}
			get
			{
				return _CheckedCompanyInfo;
			}		
		}
		...
		public string ProducePlaceInfo
		{
			set
			{
				_ProducePlaceInfo=value;
			}
			get
			{
				return _ProducePlaceInfo;
			}		
		}
		...
		public string MachineCompany
		{
			set
			{
				_MachineCompany=value;
			}
			get
			{
				return _MachineCompany;
			}		
		}
		...
		public string CheckMachineModel
		{
			set
			{
				_CheckMachineModel=value;
			}
			get
			{
				return _CheckMachineModel;
			}		
		}
		...
		public string  CheckUnitName
		{
			set
			{
				_CheckUnitName=value;
			}
			get
			{
				return _CheckUnitName;
			}		
		}	
		public string  CheckUnitInfo
		{
			set
			{
				_CheckUnitInfo=value;
			}
			get
			{
				return _CheckUnitInfo;
			}		
		}	
