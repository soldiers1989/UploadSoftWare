...
{
    public class clsDY6201 : CommBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        private void doDataResult(string input, string item)
        {
            ...
            for (int j = 0; j < len; j++)
            {
                ...
                strWhere.Append(" checkMachine='022'");
        ...
        protected override void OnRxChar(byte rec)
        {
            ...
            if (ind >= 0)//表示数据采集完成
            {
                ...
                for (int i = 0; i < len; i++)
                {
                    ...
                    switch (itemNum)
                    {
						case "01": item = "重金属汞"; break;   //原为[减肥酚酞]
						case "02": item = "重金属砷"; break;
						case "03": item = "重金属铅"; break;
						case "04": item = "亚硝酸盐"; break;
