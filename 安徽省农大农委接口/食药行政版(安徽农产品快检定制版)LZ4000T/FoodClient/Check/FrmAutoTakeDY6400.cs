...
namespace FoodClient
{
    ...
    public class FrmAutoTakeDY6400 : FrmAutoTakeDY
    {
            ...
            : base(tag)
        {
            ...
            this.btnMachineDel.Location = new System.Drawing.Point(205, 548);
        ...
        private void FrmAutoTakeDY6400_Load(object sender, EventArgs e)
        {
            ...
            base.btnReadHis.Location = new Point(32, 548);//107
            base.btnClear.Location = new Point(125, 548);//170
            base.lblSuppresser.Text = "水分含量：";
            this.BindCheckItem();
            base.BindInit();
        }
        ...
        protected override void btnClear_Click(object sender, EventArgs e)
        {
            ...
            c1FlexGrid1.DataSource = dy6400.checkDtbl;
