...
{
    public class FrmAutoTakeDY6201 : FrmAutoTakeDY
    {
        private clsDY6201 dy6200;
        private string tagName = string.Empty;
        private System.Windows.Forms.Button btnMachineDel;
        public FrmAutoTakeDY6201(string tag)
            : base(tag)
        {
            this.tagName = tag;

            this.btnMachineDel = new System.Windows.Forms.Button();
            this.btnMachineDel.Location = new System.Drawing.Point(200, 571);
        ...
        private void FrmAutoTakeDY6200_Load(object sender, EventArgs e)
        {
            ...
            base.btnClear.Location = new System.Drawing.Point(125, 571);
        ...
        {
            dy6200.checkDtbl.Clear();
            c1FlexGrid1.DataSource = dy6200.checkDtbl;
