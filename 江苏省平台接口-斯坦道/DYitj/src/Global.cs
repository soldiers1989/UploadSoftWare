...
namespace AIO
{
    ...
    public class Global
    {
        ...
        //江苏接口
        public static string StallNum = string.Empty;//摊位编号
        public static string CheckUnitName = string.Empty;//检测单位名称
        public static string MachineName = string.Empty;//仪器名称
        public static string MachineID = string.Empty;//设备ID
        public static string MachineSerial = string.Empty;//设备系列号
        public static string ManifactName = string.Empty;//设备厂家
        public static string companytype = string.Empty;//企业类型
        public static int Scount = 0;
        public static int iCurPage = 0;//请求被检单位的当前页
        ...
        /// 已选的被检单位
        /// </summary>
        public static string Selectcompany = string.Empty;
        /// <summary>
        /// 摊位编号
        /// </summary>
        public static string companystallNum = string.Empty;
        /// <summary>
        /// 是否启用视频播放功能
        /// </summary>
        ...
        /// <summary>
        /// 目前有两种类型的接口：DY 代表食安科技本身的监管平台；ZH 代表广东省智慧食药监管平台
        /// </summary>
        ...
        /// <returns></returns>
        public static string GETGUID(string format, int strCase)
        {
        ...
        /// <returns></returns>
        public static string MDFiveStr(string pwd)
        {
            string rtnStr = string.Empty;
            try
            {
               
                rtnStr =  FormsAuthentication.HashPasswordForStoringInConfigFile(pwd, "MD5").ToString();
            }
            catch (Exception)
            {
                return string.Empty;
