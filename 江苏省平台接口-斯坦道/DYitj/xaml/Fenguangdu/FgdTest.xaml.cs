...
namespace AIO.xaml.Fenguangdu
{
    ...
    public partial class FgdTest : Window
    {
        ...
        #region 全局变量
        UpdateADThread _updateADThread;
        List<Label> _list0 = null;
        List<Label> _list1 = null;
        List<Label> _list2 = null;
        List<Label> _list3 = null;
        List<Label> _list4 = null;
        List<Label> _list5 = null;
        List<Label> _list6 = null;
        List<Label> _list7 = null;
        List<Label> _list8 = null;
        FgdCaculate.HolesAD _HolesFullAD, _HolesCurAD;
        //FgdCaculate.AT[] _firstATs, _lastATs, _curATs;
        int _adClear = 0;
        //一个通道四个灯的最大值和最小值
        double _Max1 = 0, _Max2 = 0, _Max3 = 0, _Max4 = 0, _Min1 = 0, _Min2 = 0, _Min3 = 0, _Min4 = 0;
        double _num1 = 0, _num2 = 0, _num3 = 0, _num4 = 0;
        int _tglMax1 = 0, _tglMax2 = 0, _tglMax3 = 0, _tglMax4 = 0;
        int _tglMin1 = 0, _tglMin2 = 0, _tglMin3 = 0, _tglMin4 = 0;
        List<bool> _boolL = new List<bool>();
        //记录上一次测试的最大值和最小值
        ...
        public List<double> adList = new List<double>();
        public List<double> tgList = new List<double>();
        ...
        {
            if (MessageBox.Show("确定要返回到登陆界面吗?", "操作提示", MessageBoxButton.YesNo, MessageBoxImage.Question) == MessageBoxResult.Yes)
            {
                this.Close();
            }
        }
