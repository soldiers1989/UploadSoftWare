...
namespace AIO
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            //加载检测单位 摊位
            ChkCompanyStall();
            Global.MachineName= CFGUtils.GetConfig("MachineName", "");
            Global.MachineID  = CFGUtils.GetConfig("MachineID", "");
            Global.MachineSerial = CFGUtils.GetConfig("MachineSerialNum", "");
            Global.ManifactName  = CFGUtils.GetConfig("ManifactName", "");
            Global.Username = CFGUtils.GetConfig("UserName", "");
        ...
        private void ChkCompanyStall()
        {
            ...
            {
                Global.CheckUnitName = dt.Rows[0][1].ToString();
            ...
            {
                Global.StallNum = dt1.Rows[0][0].ToString();
