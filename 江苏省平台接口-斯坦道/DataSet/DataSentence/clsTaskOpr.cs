...
namespace DYSeriesDataSet
{
    ...
    public class clsTaskOpr
    {
        ...
        public DataTable GetSampleByNameOrCode(string SampleName, string Name, bool IsPreciseQuery, bool IsFirst, int type)
        {
            ...
            try
            {
                ...
                if (type == 1)
                {
                    ...
                    //if (!SampleName.Equals(string.Empty))
                    //{
                    //    sb.AppendFormat(" WHERE productName Like '%{0}%'", SampleName);                   
                    //}
        ...
        public DataTable GetSTDSampleCode(string SampleName, string Name, bool IsPreciseQuery, bool IsFirst, int type)
        {
            string errMsg = string.Empty;
            DataTable dtbl = null;
            try
