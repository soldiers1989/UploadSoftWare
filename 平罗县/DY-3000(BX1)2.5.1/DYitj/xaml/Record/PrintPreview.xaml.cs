...
namespace AIO.xaml.Record
{
    ...
    public partial class PrintPreview : Window
    {
        ...
        private void Btn_Return_Click(object sender, RoutedEventArgs e)
        {
            ...
            Cb_Xprinter.IsChecked = false;
            Cb_IsPoductCompany.IsChecked = true;
            ...
            PrintHelper.Xprinter = (bool)Cb_Xprinter.IsChecked;
            PrintHelper.PrintProductCompany = (bool)Cb_IsPoductCompany.IsChecked;
            ...
            Global.Printing[0].XPrinter  = PrintHelper.Xprinter;
            Global.Printing[0].PrintProductCompany = PrintHelper.PrintProductCompany;
        ...
        private void Btn_Save_Click(object sender, RoutedEventArgs e)
        {
            ...
            PrintHelper.Xprinter = (bool)Cb_Xprinter.IsChecked;//热干胶打印机
            PrintHelper.XprinterName = cmbPrinter.Text.Trim();
            ...
            if (Global.Printing != null && Global.Printing.Count > 0)
            {
                ...
                Global.Printing[0].PrintQR = PrintHelper.PrintQR;
                Global.Printing[0].XPrinter = PrintHelper.Xprinter;
                Global.Printing[0].XprinterName  = PrintHelper.XprinterName;
                Global.Printing[0].PrintProductCompany = PrintHelper.PrintProductCompany;
            }
            else
            {
                ...
                pp.XPrinter = PrintHelper.Xprinter;
                pp.XprinterName = PrintHelper.XprinterName;
                pp.PrintProductCompany = PrintHelper.PrintProductCompany;
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            if (Global.Printing != null && Global.Printing.Count > 0)
            {
                ...
                Cb_IsPoductCompany.IsChecked = PrintHelper.PrintProductCompany   = Global.Printing[0].PrintProductCompany;
                Cb_Xprinter.IsChecked = PrintHelper.PrintQR = Global.Printing[0].XPrinter;
                cmbPrinter.Text = PrintHelper.XprinterName = Global.Printing[0].XprinterName ;

            }
        }

        private void cmbPrinter_DropDownOpened(object sender, System.EventArgs e)
        {
        ...
        private void cmbPrinter_DropDownClosed(object sender, System.EventArgs e)
        {
