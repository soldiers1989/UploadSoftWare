...
namespace AIO
{
    ...
    public class DYFGDItemPara
    {
        ...
        public class DYIRPara
        {
            ...
            public string SaveTime = "";//保存上一次对照值的时间
        }
        // 标准曲线法的参数
        [Serializable]
    ...
    public class DYJTJItemPara
    {
        ...
        public double InvalidC, newInvalidC, threeInvalidC, fourInvalidC;
        ...
        {
            public double[] MaxT, newMaxT,threeMaxT,fourMaxT;
            public double[] MinT, newMinT, threeMinT,fourMinT;
            //public double[] Abs;
            public double Abs_Min = 0, Abs_Max = 0;
        }
