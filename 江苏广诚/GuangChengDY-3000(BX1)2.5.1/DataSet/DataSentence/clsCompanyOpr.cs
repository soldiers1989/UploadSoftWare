...
namespace DYSeriesDataSet
{
    ...
    public class clsCompanyOpr
    {
        ...
        public DataTable GetProject(string where ,string order,out string errMsg)
        {
            errMsg = string.Empty;
            DataTable dt = null;
            sql.Length = 0;
            try
            {
                sql.Append("select * from GCDepartment ");
                ...
                string[] cmd = new string[1] { sql.ToString() };
                string[] names = new string[1] { "GCDepartment" };
                dt = DataBase.GetDataSet(cmd, names, out errMsg).Tables["GCDepartment"];
        ...
        public int InsertProject(projectdata model, out string errMsg)
        {
            errMsg = string.Empty;
            int rtn = 0;
            try
            {
                sql.Length = 0;
                sql.Append("insert into  GCDepartment(did,jgmc) values (");
                sql.AppendFormat("'{0}',",model.id );
                sql.AppendFormat("'{0}')",model.jgmc  );
                DataBase.ExecuteCommand(sql.ToString(), out errMsg);
                sql.Length = 0;
                rtn = 1;
            }
        ...
        public int DeleteProject(string where,string order,out string errMsg)
        {
            errMsg = string.Empty;
            int rtn = 0;
            try
            {
                sql.Length = 0;
                sql.Append("delete from  GCDepartment ");
        ...
        public DataTable GetCompany(string where, string order, out string errMsg)
        {
            errMsg = string.Empty;
            DataTable dt = null;
            sql.Length = 0;
            try
            {
                sql.Append("select * from GCCompany ");
                ...
                string[] cmd = new string[1] { sql.ToString() };
                string[] names = new string[1] { "GCCompany" };
                dt = DataBase.GetDataSet(cmd, names, out errMsg).Tables["GCCompany"];
        ...
        public int InsertCompany(Companydata model,string companyID,string company, out string errMsg)
        {
            errMsg = string.Empty;
            int rtn = 0;
            try
            {
                sql.Length = 0;
                sql.Append("insert into  GCCompany(cid,bjcdwmc,projectID,proect) values (");
                sql.AppendFormat("'{0}',", model.id);
                sql.AppendFormat("'{0}',", model.bjcdwmc );
                sql.AppendFormat("'{0}',", companyID);
                sql.AppendFormat("'{0}')", company);
        ...
        public int DeleteCompany(string where, string order, out string errMsg)
        {
            errMsg = string.Empty;
            int rtn = 0;
            try
            {
                sql.Length = 0;
                sql.Append("delete from  GCCompany ");
        ...
        public DataTable GetStall(string where, string order, out string errMsg)
        {
            errMsg = string.Empty;
            DataTable dt = null;
            sql.Length = 0;
            try
            {
                sql.Append("select * from GCStall ");
                ...
                string[] cmd = new string[1] { sql.ToString() };
                string[] names = new string[1] { "GCStall" };
                dt = DataBase.GetDataSet(cmd, names, out errMsg).Tables["GCStall"];
        ...
        public int InsertStall(Stalldata model,string company,string id, out string errMsg)
        {
            errMsg = string.Empty;
            int rtn = 0;
            try
            {
                sql.Length = 0;
                sql.Append("insert into  GCStall(sid,twhmc,companyID,comany) values (");
                sql.AppendFormat("'{0}',", model.id );
                sql.AppendFormat("'{0}',", model.twhmc );
        ...
        public int DeleteStall(string where, string order, out string errMsg)
        {
            errMsg = string.Empty;
            int rtn = 0;
            try
            {
                sql.Length = 0;
                sql.Append("delete from  GCStall ");
