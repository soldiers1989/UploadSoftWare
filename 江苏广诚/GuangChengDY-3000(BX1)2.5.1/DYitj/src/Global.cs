...
namespace AIO
{
    public class Global
    {
        ...
        public static List<Prints> Printing;
        public static string PrintViewFile = AccountsDirectory + "\\" + "PrintSet.dat";
        ...
        /// 软件版本号;
        /// </summary>
        public static byte[] JtjVerTwo = null;
        /// <summary>
        /// 胶体金通道三
        /// </summary>
        public static byte[] JtjVerThree = null;
        /// <summary>
        /// 胶体金通道四
        /// </summary>
        public static byte[] JtjVerFour = null;
        ...
        /// <summary>
        /// 通道1  胶体金版本，1为第一代，2第二代，3第三代(新摄像头模组)
        /// </summary>
        public static int JtjVersion = 1;
        /// <summary>
        /// 通道2  胶体金版本，1为第一代，2第二代，3第三代(新摄像头模组)
        /// </summary>
        public static int JtjVersionTwo = 1;
        public static int JtjVersionThree = 1;
        public static int JtjVersionFour = 1;
        /// <summary>
        /// 是否为DY-3500(I)设备
        /// </summary>
        public static bool Is3500I = false;
        /// <summary>
        /// 摄像头进出口标志
        /// </summary>
        public static bool SXTInOut = false;
        ...
        /// 摄像头串口集合
        /// </summary>
        public static ComPort[] sxtPorts = new ComPort[4];
        /// <summary>
        /// 广诚的登录返回Token
        /// </summary>
        ...
        /// 项目部名称
        /// </summary>
        public static string projectDepart = "";
        public static string projectDepartID = "";

        public static string departName = "";
        public static string departIDCode = "";
        public static string stallNum = "";
        public static string stallIDCode = "";

        /// <summary>
        /// 设备唯一码
        /// </summary>
        public static string DeviceID = string.Empty;
        internal static double nHelpBoxWidth = double.Parse(CFGUtils.GetConfig("nHelpBoxWidth",Is3500I ?"20": "15"));
        ...
        internal static double nHelpBoxLeft3 = double.Parse(CFGUtils.GetConfig("nHelpBoxLeft3", "118"));
        internal static double nHelpBoxTop3 = double.Parse(CFGUtils.GetConfig("nHelpBoxTop3", "32"));
        internal static double nHelpBoxLeft4 = double.Parse(CFGUtils.GetConfig("nHelpBoxLeft4", "118"));
        internal static double nHelpBoxTop4 = double.Parse(CFGUtils.GetConfig("nHelpBoxTop4", "32"));
        internal static int LineCount = int.Parse(CFGUtils.GetConfig("LineCount", "5"));
        ...
        public static void SerializeToFile(List<Prints> accounts, string filePath)
        {
            try
            {
                BinarySerialize<List<Prints>> serialize = new BinarySerialize<List<Prints>>();
                serialize.Serialize(accounts, filePath);
            }
            catch (Exception ex)
            {
        ...
        //打印
        public static void DeSerializeFromFile(out List<Prints> accounts, string filePath)
        {
            try
            {
                BinarySerialize<List<Prints>> serialize = new BinarySerialize<List<Prints>>();
        ...
        {
            //获取胶体金硬件版本号
            if (JtjVersionInfo == null || JtjVerTwo == null )
            {
                ...
                msg1.str1 = strSXT2PORT;
                msg1.str2 = "通道2";
                workThread.SendMessage(msg1, null);
            }
