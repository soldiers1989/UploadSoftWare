...
namespace AIO
{
    ...
    public partial class App : Application
    {
        ...
        private void Application_Startup(object sender, StartupEventArgs e)
        {
            ...
            // 读取config文件，并设置全局变量
            Global.projectDepart = CFGUtils.GetConfig("GCproject", "崇川区项目部");
            Global.projectDepartID = CFGUtils.GetConfig("GCprojectID", "1");
            ...
            //是否为DY3500(I)
            //if (Global.InstrumentNameModel + Global.InstrumentName == "DY-3500(I)食品综合分析仪")
            //    Global.Is3500I = true;
