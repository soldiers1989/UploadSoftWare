    ...
    public partial class GszSelChannelWindow : Window
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            if (Global.ismore == true)
            {
                ...
                {
                    MessageBox.Show("干化学测试只有四个检测通道，不能选择多于4个样品");
                    return;
                }
            ...
            if (Global.ismore == true)
            {
                ...
                for (i = 0; i < Global.deviceHole.SxtCount; ++i)
                {
                        ...
                        List<string> sNameList = new List<string>
                    {
                        ...
                        _item.Hole[i].SampleId =Global.NTCheckMassage[i,2]; //listTextBoxSampleid.Count > 0 ? listTextBoxSampleid[i].Text.Trim() : string.Empty;//样品编号
        ...
        private void textBoxSampleName_MouseDoubleClick(object sender, MouseButtonEventArgs e)
        {
            ...
            //searchTaskWindow._item = Global.gszItems[_SelIndex].Name;
            //searchTaskWindow.ShowDialog();
            //DataTable dt = _clsTaskOpr.SearchSampleStd(Global.NTsample, Global.gszItems[_SelIndex].Name, 1);
