...
namespace AIO.xaml.Dialog
{
    ...
    public partial class AddOrUpdateSample : Window
    {
        ...
        public string _standvalue = string.Empty;
        /// <summary>
        /// 在本地数据库中未找到时新增的样品名称
        /// </summary>
        ...
        private void SetCheckBox()
        {
            ...
            //标准值
            IList<string> standlist = new List<string>();
            IDictionary<string, string> dicstand = new Dictionary<string, string>();
                ...
                if (dataTable != null && dataTable.Rows.Count > 0)
                {
                    ...
                    if (ItemNames != null && ItemNames.Count > 0)
                    {
                        for (int i = 0; i < ItemNames.Count; i++)
                        {
                            ...
                            str = ItemNames[i].StandardValue;
                            if (!str.Equals(string.Empty) && !dicstand.ContainsKey(str))
                            {
                                dicstand.Add(str,str);
                                standlist.Add(str);
                            }
            ...
            finally
            {
                ...
                this.textBoxStandardValue.Text = _ItemNames[0].StandardValue;//标准值
            }
        }
