...
namespace AIO
{
    ...
    public class Global
    {
        ...
        /// 是否进入样品小精灵
        /// </summary>
        public static bool InSampleelf = false;
        /// <summary>
        /// 南通检测样品
        /// </summary>
        public static string NTsample = string.Empty;
        /// <summary>
        /// 南通检测项目
        /// </summary>
        public static string NTitem = string.Empty;
        /// <summary>
        /// 南通样品编号
        /// </summary>
        public static string NTsamplecode = string.Empty;
        /// <summary>
        /// 南通已选样品ID
        /// </summary>
        public static string _selSampleID = string.Empty;
        /// <summary>
        /// 南通已选样品名称
        /// </summary>
        public static string _selSamplename = string.Empty;
        /// <summary>
        /// 南通已选检测项目
        /// </summary>
        public static string _itemname = string.Empty;
        /// <summary>
        /// 南通已选任务时间
        /// </summary>
        public static string _tasktime = string.Empty;
        /// <summary>
        /// 南通检测信息
        /// </summary>
        public static string[,] NTCheckMassage =null;
        /// <summary>
        /// 是否多选
        /// </summary>
        public static bool ismore = false;
        ...
        /// 登录用户名
        /// </summary>
        public static string LoggonNmae = string.Empty;
        /// <summary>
        /// 设备厂家
        /// </summary>
        public static string MachineMaker = string.Empty;
        /// <summary>
        ///设备系列号
        /// </summary>
        public static string MachineSerial = string.Empty;
