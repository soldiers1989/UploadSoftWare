...
namespace FoodClient
{
	...
	public class frmCheckComType : System.Windows.Forms.Form
	{
		...
		private void cmdDelete_Click(object sender, C1.Win.C1Command.ClickEventArgs e)
		{
			...
			{
				MessageBox.Show(this,"系统所设定的存在"+this.c1FlexGrid1[row,"TypeName"].ToString()+"类型的检测点！所以不能删除");
				return;
			}
			//让用户确定删除操作
		...
		private void setGridStyle()
		{
			...
			this.c1FlexGrid1.Cols["ID"].Caption="系统编号";
			this.c1FlexGrid1.Cols["TypeName"].Caption="检测点类型名称";
			this.c1FlexGrid1.Cols["NameCall"].Caption="单位名称域标题";
			this.c1FlexGrid1.Cols["AreaCall"].Caption="所属组织机构域标题";
			this.c1FlexGrid1.Cols["VerType"].Caption="对应版本";
			this.c1FlexGrid1.Cols["IsLock"].Caption="停用";
			this.c1FlexGrid1.Cols["IsReadOnly"].Caption="已审核";
			this.c1FlexGrid1.Cols["ComKind"].Caption="单位类别编号";
			this.c1FlexGrid1.Cols["ComKindName"].Caption="所属单位类别";
			this.c1FlexGrid1.Cols["AreaTitle"].Caption ="所属组织域标题";
			this.c1FlexGrid1.Cols["NameTitle"].Caption ="受检人/单位域标题";
			this.c1FlexGrid1.Cols["DomainTitle"].Caption ="位置编号域标题";
			this.c1FlexGrid1.Cols["SampleTitle"].Caption ="样品名称域标题";
...
//			PrintOperation.PrintGrid(this.c1FlexGrid1,"单位类别列表",null);
			PrintOperation.PreviewGrid(this.c1FlexGrid1,"检测点类型表",null);
		}
