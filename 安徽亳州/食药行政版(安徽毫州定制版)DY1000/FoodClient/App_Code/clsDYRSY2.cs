                ...
                else
                {
                    ...
                    if (input.Substring(0, 4) == "0144" && IsNewVersion)
                    {
                        ...
                        else
                        {
                            ...
                            if (MessageNotify.Instance() != null)
                            {
                                MessageNotify.Instance().SendMessage(MessageNotify.NotifyInfo.ReadSFYData, "V");//表示读取版本
                            }
                        }
                    }
                    else if (!IsNewVersion)//第二代
                    {
                        ...
                        else
                        {
                            ...
                            if (MessageNotify.Instance() != null)
                            {
                                MessageNotify.Instance().SendMessage(MessageNotify.NotifyInfo.ReadSFYData, "");//表示读取版本
                            }
                        }
                    }
                    else
