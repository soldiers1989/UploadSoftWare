    ...
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //单身
                Global.InstrumentType= ConfigurationManager.AppSettings["IntrumentType"];//仪器类型
                Global.IntrumentNums  = ConfigurationManager.AppSettings["IntrumentNums"];//仪器编号
                Global.MacAddr  = ConfigurationManager.AppSettings["MacAddr"];//MAC地址
                Global.InterfaceVer = ConfigurationManager.AppSettings["InterfaceVer"];//接口版本
