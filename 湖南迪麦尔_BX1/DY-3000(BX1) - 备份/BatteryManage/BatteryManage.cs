...
namespace BatteryManage
{
    public partial class BatteryManage : Form
    {
        ...
        private void BatteryManage_FormClosed(object sender, FormClosedEventArgs e)
        {
       
            notifyiconMnu.Dispose();
            notifyIcon.Dispose();
            //Environment.Exit(Environment.ExitCode);
            Application.Exit();
        }

        private void BatteryManage_FormClosing(object sender, FormClosingEventArgs e)
        {
