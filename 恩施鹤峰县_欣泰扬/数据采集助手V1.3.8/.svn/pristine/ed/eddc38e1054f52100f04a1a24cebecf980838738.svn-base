...
{
    public class clsShareOption
    {
        /// <summary>
        ///静态类防止外部构造
        /// </summary>
        private clsShareOption()
        {
        ...
        ///连网服务器IP 编号为020201
        /// </summary>
        public static string SysServerUrl = string.Empty;

        /// <summary>
        /// 连网用户账号,编号为020202
        /// </summary>
        public static string SysServerUser = string.Empty;

        /// <summary>
        /// 连网用户密码,系统设置编号为020203
        /// </summary>
        public static string SysServerPwd = string.Empty;
