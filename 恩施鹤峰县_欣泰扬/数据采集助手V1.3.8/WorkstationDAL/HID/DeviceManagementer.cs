...
namespace WorkstationDAL.HID
{
    ...
    public partial class DeviceManagement : Control
    {
            ...
            try
            {
                ...
                if (deviceFound)
                {
                    ...
                    do
                    {
                        ...
                        device.HidHandle = FileIODeclarations.CreateFile(devicePathName[memberIndex], 0, FileIODeclarations.FILE_SHARE_READ | FileIODeclarations.FILE_SHARE_WRITE, IntPtr.Zero, FileIODeclarations.OPEN_EXISTING, 0, 0);
                        ...
                        if (!device.HidHandle.IsInvalid)
                        {
                            ...
                            success = HidDeclarations.HidD_GetAttributes(device.HidHandle, ref _hidObject.DeviceAttributes);
        ...
        private void ReOpenDeviceFileStreamHandler(DeviceInformation findDevice)
        {
            ...
            findDevice.HidHandle = FileIODeclarations.CreateFile(findDevice.myDevicePathName, FileIODeclarations.GENERIC_READ | FileIODeclarations.GENERIC_WRITE, FileIODeclarations.FILE_SHARE_READ | FileIODeclarations.FILE_SHARE_WRITE, IntPtr.Zero, FileIODeclarations.OPEN_EXISTING, 0, 0);
        ...
        public void OnDeviceChange(Message m)
        {
            ...
            try
            {
                ...
                else if ((m.WParam.ToInt32() ==DeviceManagementDeclarations.DBT_DEVICEREMOVECOMPLETE))
                {
        ...
        /// <param name="useControlTransfersOnly"></param>
        /// <param name="outDatas"></param>
        /// <param name="inputDatas"></param>
        /// <param name="timeout"></param>
        /// <returns></returns>
