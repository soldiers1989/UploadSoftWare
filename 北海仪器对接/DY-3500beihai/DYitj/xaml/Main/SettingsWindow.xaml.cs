    ...
    public partial class SettingsWindow : Window
    {
        ...
        private void SaveSetting()
        {
            try
            {
                ...
                textBoxCheckNumber.Text = Global.UnitID;
                textCheckPlaceCode.Text = Global.UnitID;
                ...
                textBoxCheckName.Text = Global.UnitName;
                CPoint.pointName = Global.UnitName;
                if (Global.samplenameadapter.Count == 0)
                ...
                Global.samplenameadapter[0].userId = Global.UnitID;
                Global.samplenameadapter[0].pointName = Global.UnitName ;
            }
            catch (Exception ex)
            {
                ...
                switch (msg.what)
                {
                    ...
                    case MsgCode.MSG_CHECK_CONNECTION:
                        ...
                        if (msg.result)
                        {
                            ...
                            MessageBox.Show(wnd, "用户登录验证成功!", "系统提示", MessageBoxButton.OK, MessageBoxImage.Information);
                        }
                        else
                        {
