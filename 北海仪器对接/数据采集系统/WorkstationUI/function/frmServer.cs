    ...
    public partial class frmServer : Form
    {
            ...
            try
            {
                ...
                if (ReturnMessage.Contains("status"))
                {
                    ...
                    if (com.status == "1")
                    {
                        ...
                        Global.BCheckUnitName = com.unitname;
                        txtOrganizeNo.Text = Global.CheckUnitcode;
                        txtDetectUnit.Text = Global.BCheckUnitName;
        ...
        { 
            try
            {
                ...
                if (unitname != null)
                {
                    cf.AppSettings.Settings["UpDetectUnit"].Value = Global.BCheckUnitName ;
                }
                else
                {
                    cf.AppSettings.Settings.Add("UpDetectUnit", Global.BCheckUnitName);
                }
                //检测站编号
                string unitno = ConfigurationManager.AppSettings["UpDetectUnitNo"];
                if (unitno != null)
                {
                    cf.AppSettings.Settings["UpDetectUnitNo"].Value = Global.CheckUnitcode;
                }
                else
                {
                    cf.AppSettings.Settings.Add("UpDetectUnitNo", Global.CheckUnitcode);
                }
                //机构名称
