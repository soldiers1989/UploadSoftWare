...
{
    /// <summary>
    /// Note：生成随机验证码,调用方法：ValidCode validCode = new ValidCode(5, ValidCode.CodeType.Alphas);
    /// 图片资源：this.image1.Source = BitmapFrame.Create(validCode.CreateCheckCodeImage())
    /// 验证码：validCode.CheckCode;
    /// Creater：wenj
    /// Time：2018/1/19 11:38:13
    /// Version：V1.0.0
    /// </summary>
