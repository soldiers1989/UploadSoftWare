...
namespace DYSeriesDataSet
{
    public class tlsTtResultSecond
    {
        ...
        public string CheckMachine
        {
            get
            {
                return m_CheckMachine.Length == 0 ? "DY-3000(BX1) 便携式食品综合分析仪" : m_CheckMachine;
            }
            set
            {
        ...
        public string CheckMachineModel
        {
            get
            {
                return m_CheckMachineModel.Length == 0 ? "DY-3000(BX1)" : m_CheckMachineModel;
            }
            set
            {
        ...
        public string MachineCompany
        {
            get
            {
                return m_MachineCompany.Length == 0 ? "广东达元绿洲食品安全科技股份有限公司" : m_MachineCompany;
            }
            set
            {
        ...
        {
            get { return m_SysCode.Length == 0 ? Guid.NewGuid().ToString().ToUpper() : m_SysCode; }
            set { m_SysCode = value; }
        }
        ...
        {
            get { return _quanOrQual; }
            set { _quanOrQual = value; }
        }
        ...
        {
            get { return _ProduceCompany; }
            set { _ProduceCompany = value; }
        }
        private string _Opertorname = string.Empty;
        public string Opertorname
        {
            get { return _Opertorname; }
            set { _Opertorname = value; }
        }
        ...
        private string _stallNumber = string.Empty;
