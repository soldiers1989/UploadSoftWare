                    ...
                    if (_contrast)
                    {
                        ...
                        for (int i = 0; i < Global.deviceHole.HoleCount; ++i)
                        {
                            if (_use[i] && i != contrastIdx)
                            {
                                ...
                                _CheckValue[(num > 0 ? (i - num) : i), 19] = _item.Hole[i].OpertorNames;// string.IsNullOrEmpty(_item.Hole[i].SampleId) ? string.Empty : _item.Hole[i].SampleId;
                                _CheckValue[(num > 0 ? (i - num) : i), 20] = _item.Hole[i].ProduceCompany;

                                _CheckValue[(num > 0 ? (i - num) : i), 21] = _item.Mitem ;
                                _CheckValue[(num > 0 ? (i - num) : i), 22] = _item.MCode ;
                                _CheckValue[(num > 0 ? (i - num) : i), 23] = _item.MType ;
