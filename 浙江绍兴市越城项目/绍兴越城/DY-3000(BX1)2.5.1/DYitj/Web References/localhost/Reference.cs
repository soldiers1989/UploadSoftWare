...
namespace FoodClient.localhost
{
    ...
    public partial class DataSyncService : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        {
            object[] results = this.Invoke("CheckChePoint", new object[] {
                        in0,
                        in1,
                        in2,
                        in3,
        ...
        {
            return this.BeginInvoke("CheckChePoint", new object[] {
                        in0,
                        in1,
                        in2,
                        in3,
        ...
        public void CheckChePointAsync(string in0, string in1, string in2, string in3, string in4, string in5, object userState)
        {
            ...
            this.InvokeAsync("CheckChePoint", new object[] {
                        in0,
                        in1,
                        in2,
                        in3,
                        in4,
                        in5}, this.CheckChePointOperationCompleted, userState);
        }
        ...
        {
            object[] results = this.Invoke("getResultsDataDriver", new object[] {
                        in0,
                        in1});
            return ((string)(results[0]));
        }
        ...
        {
            return this.BeginInvoke("getResultsDataDriver", new object[] {
                        in0,
                        in1}, callback, asyncState);
        }
        ...
        public void getResultsDataDriverAsync(string in0, string in1, object userState)
        {
            ...
            this.InvokeAsync("getResultsDataDriver", new object[] {
                        in0,
                        in1}, this.getResultsDataDriverOperationCompleted, userState);
        }
        ...
        {
            object[] results = this.Invoke("downLoadDataDriverBySign", new object[] {
                        in0,
                        in1,
                        in2,
                        in3,
