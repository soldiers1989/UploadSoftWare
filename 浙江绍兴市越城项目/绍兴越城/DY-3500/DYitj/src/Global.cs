...
namespace AIO
{
    ...
    public class Global
    {
        ...
        public static List<CheckPointInfo> samplenameadapter;
        public static string samplenameadapterFile = AccountsDirectory + "\\" + "FoodClass.dat";
        public static List<ItemsAdapter> adapteritem;
        ...
        /// 越城检测项目
        /// </summary>
        public static string YCitemname = "";
        /// <summary>
        /// 经营户姓名
        /// </summary>
        ...
        /// 是否打印演示印章
        /// </summary>
        public static bool EnableChapter { get; set; }

        /// <summary>
        /// 是否启用验证码
        /// </summary>
        public static bool EnableValidCode { get; set; }
        ...
        public static bool EnableKnowledgeBase { get; set; }
        ...
        public static string CurveValue { get; set; }
    }
}