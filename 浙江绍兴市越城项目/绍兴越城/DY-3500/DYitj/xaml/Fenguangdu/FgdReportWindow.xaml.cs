    ...
    public partial class FgdReportWindow : Window
    {
            ...
            try
            {
                ...
                for (int i = 0; i < HoleCount; ++i)
                {
                    ...
                    if (_item.Method == 0 || _item.Method == 3)
                    {
                        ...
                        {
                            _use[i] = true;
                            _CheckValue = new string[_HoleNumber, 30];
                            _HoleNumber++;
                            num++;
                        }
                        else
        ...
        private string[] GetResult(string[] Qualifide, string strValue)
        {
            ...
            if (0 == _item.Method)
            {
                ...
                Qualifide[1] = Qualifide[1].Length == 0 ? "参考国标" : Qualifide[1];
                        ...
                        for (int i = 0; i < HoleCount; ++i)
                        {
                            if (_use[i] && i != contrastIdx)
                            {
                                ...
                                if (str == "NA")
                                {
                                    ...
                                    UnqualifiedValue[1] = UnqualifiedValue[1].Length == 0 ? "参考国标" : UnqualifiedValue[1];
                                ...
                                //匹配项目
                                _CheckValue[(num > 0 ? (i - num) : i), 17] = _item.Mitem;
                                _CheckValue[(num > 0 ? (i - num) : i), 18] = _item.MCode ;
                                _CheckValue[(num > 0 ? (i - num) : i), 19] = _item.MType ;
                            }
                            else
                            {
                                num += 1;
