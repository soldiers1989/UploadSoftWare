...
namespace DYSeriesDataSet
{
    public class tlsTtResultSecond
    {
        ...
        private string _SampleFoodCode = string.Empty;

        /// <summary>
        /// 抽样单样品编号 foodCode *
        /// </summary>
        public string SampleFoodCode
        {
            get { return _SampleFoodCode; }
            set { _SampleFoodCode = value; }
        }

        private string _Sdid = string.Empty;
        /// <summary>
        /// 抽样任务明细id
        /// </summary>
        public string Sdid
