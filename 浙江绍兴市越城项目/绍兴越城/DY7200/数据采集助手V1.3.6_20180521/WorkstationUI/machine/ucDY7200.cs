...
namespace WorkstationUI.machine
{
    public partial class ucDY7200 : BasicContent
    {
        ...
        private void ucDY7200_Load(object sender, EventArgs e)
        {
            ...
            cmbChkItem.MouseClick += cmbChkItem_MouseClick;
            ...
            //cmbSample.MouseDoubleClick += cmbSample_MouseDoubleClick;
            ...
            {
                cdt = _sql.GetYCOpertorTable("");
                if (cdt != null && cdt.Rows.Count > 0)
                {
                      for (int n = 0; n < cdt.Rows.Count; n++)
                      {
                          if (cdt.Rows[n]["isselect"].ToString() == "True")
                          {
                              dy7200s.unitInfo[0, 0] = cdt.Rows[n]["marketName"].ToString();//被检单位
                              dy7200s.unitInfo[0, 1] = cdt.Rows[n]["operatorName"].ToString();//经营户
                          }
                          cmbDetectUnit.Items.Add(cdt.Rows[n]["marketName"].ToString());//被检单位
                          cmbDetectUnitNature.Items.Add(cdt.Rows[n]["operatorName"]);//经营户
                      }
                }
        ...
        private void cmbChkItem_MouseClick(object sender, MouseEventArgs e)
        {
            if (DateTime.Now - dtCmbLastClick < new TimeSpan(0, 0, 0, 0, GetDoubleClickTime()))
            {
                ...
                frm.ShowDialog();
                if (frm.item != "")
                    CheckDatas.CurrentCell.Value = frm.item;
                CheckDatas.CurrentCell.Value = cmbChkItem.Text = frm.item;
            }
            else
            {
        ...
        private void cmbSample_MouseClick(object sender, MouseEventArgs e)
        {
            if (DateTime.Now - dtCmbLastClick < new TimeSpan(0, 0, 0, 0, GetDoubleClickTime()))
            {
                ...
                CheckDatas.CurrentCell.Value = cmbSample.Text = frm.sampleName;

                string sql = "FtypeNmae='" + frm.sampleName + "'" + " and  Name='" + CheckDatas.Rows[CheckDatas.CurrentCell.RowIndex].Cells["检测项目"].Value.ToString().Trim() + "'";
        ...
        private  void cmbSample_MouseDoubleClick(object sender, MouseEventArgs e)
        {
        ...
        private void cmbChkItem_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cmbChkItem.Text == "以下相同")
            {
                ...
                {
                    CheckDatas.Rows[k].Cells[3].Value = CheckDatas.CurrentCell.Value.ToString();
                }
            }
        ...
        private void cmbDetectUnit_MouseClick(object sender, MouseEventArgs e)
        {
            if (DateTime.Now - dtCmbLastClick < new TimeSpan(0, 0, 0, 0, GetDoubleClickTime()))
            {
                ...
                if (window._company != "")
                {
                    ...
                    CheckDatas.CurrentCell.Value = cmbSample.Text = window._company;
                    //cmbDetectUnit.Visible = false;
                }
            }
            else
        ...
        protected override void btnDatsave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (CheckDatas.Rows.Count > 0)
                {
                    ...
                    {
                        if (CheckDatas.Rows[i].Cells["样品名称"].Value.ToString().Trim() == "" || CheckDatas.Rows[i].Cells["匹配项目"].Value.ToString().Trim() == "")
                        {
                            continue;
                        }
                        ...
                        {
                            string samplecode = "";
                            dt= _sql.GetSample("goodsName='" + CheckDatas.Rows[i].Cells["样品名称"].Value.ToString().Trim() + "'", "", out err);
                            if (dt != null && dt.Rows.Count > 0)
                            {
                                samplecode = dt.Rows[0]["goodsCode"].ToString();
                            }
                            ...
                            //resultdata.CheckUnitNature = CheckDatas.Rows[i].Cells["被检单位性质"].Value.ToString().Trim();
                            ...
                            resultdata.NumberUnit = CheckDatas.Rows[i].Cells["数量单位"].Value.ToString().Trim();
                            ...
                            resultdata.ItemName = CheckDatas.Rows[i].Cells["匹配项目"].Value.ToString().Trim();
                            resultdata.MachineCode = "DY-7200(I)";

                            DataTable dtitem= _sql.GetYCItemTable("itemName='"+resultdata.ItemName+"'");
                            if (dtitem != null && dtitem.Rows.Count >0)
                            {
                                resultdata.ItemCode = dtitem.Rows[0]["itemCode"].ToString().Trim();
                            }
                            resultdata.Operator = CheckDatas.Rows[i].Cells["经营户"].Value.ToString().Trim();
                            DataTable dtopt = _sql.GetYCOpertorTable("operatorName='" + resultdata.Operator + "'");
                            if (dtopt != null && dtopt.Rows.Count >0)
                            {
                                resultdata.OperatorCode = dtopt.Rows[0]["operatorCode"].ToString().Trim();
                                resultdata.stallnum = dtopt.Rows[0]["stallNo"].ToString().Trim();
                            }
                    ...
                    if (isave == 0)
                    {
                        MessageBox.Show("共保存" + isave + "条数据！", "提示", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    else
                    {
                ...
                else 
                {
                    ...
                    if (dt != null && dt.Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            string url = getUrl.GetUrl(Global.ServerAdd, 6);
                            ...
                            ck.uuid = dt.Rows[0]["ChkNum"].ToString().Replace("-", "").Trim();
                            ck.deviceId = Global.MachineSerialCode;
                            ck.marketName = dt.Rows[0]["CheckUnit"].ToString();//被检单位
                            ck.operatorName = dt.Rows[0]["Opertorname"].ToString();//经营户姓名
                            ck.operatorCode = dt.Rows[0]["operatorCode"].ToString();//经营户编号
                            ck.stallNo = dt.Rows[0]["stallNumber"].ToString();//必填
                            ck.checkDate = dt.Rows[0]["CheckTime"].ToString().Replace('/', '-');
                            ck.goodsName = dt.Rows[0]["SampleName"].ToString();
                            ck.amount = dt.Rows[0]["SampleNum"].ToString();
                            ck.unite = dt.Rows[0]["NumberUnit"].ToString();

                            //查询检测项目类别
                            string whereItem = "itemName ='" + dt.Rows[0]["ItemName"].ToString() + "'";
                            DataTable dtitem = _sql.GetYCItemTable(whereItem);
                            if (dtitem != null && dtitem.Rows.Count > 0)
                            {
                                ck.itemType = dt.Rows[0]["itemType"].ToString();
                            }

                            ck.itemName = dt.Rows[0]["ItemName"].ToString();
                            ck.itemCode = dt.Rows[0]["ItemCode"].ToString();
                            ck.value = dt.Rows[0]["CheckData"].ToString();
                            //ck.checkResult = dt.Rows[0]["Result"].ToString();

                            if (dt.Rows[0]["Result"].ToString() == "合格" || dt.Rows[0]["Result"].ToString() == "阴性")
                            {
                                ck.checkResult = "未检出";
                            }
                            else if (dt.Rows[0]["Result"].ToString() == "不合格" || dt.Rows[0]["Result"].ToString() == "阳性")
                            {
                                ck.checkResult = "检出";
                            }
        ...
        protected override void CheckDatas_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    if (CheckDatas.CurrentCell.ColumnIndex == 3)//匹配项目
                    {
                        frmItem frm = new frmItem();
                        frm.ShowDialog();
                        if (frm.item!="")
                    ...
                    else if(CheckDatas.CurrentCell.ColumnIndex >4 && CheckDatas.CurrentCell.ColumnIndex <8)
                    {
                        cmbSample.Visible = false;
                        cmbChkItem.Visible = false;
                        cmbChkUnit.Visible = false;
                    ...
                    else if (CheckDatas.CurrentCell.ColumnIndex == 12)//经营户
                    {
                        cmbSample.Visible = false;
                        cmbChkItem.Visible = false;
                        cmbChkUnit.Visible = false;
                        ...
                        if (CheckDatas.Rows[CheckDatas.CurrentCell.RowIndex].Cells[CheckDatas.CurrentCell.ColumnIndex - 1].Value.ToString() == "")
                        {
                            MessageBox.Show("请选择被检单位再选择经营户！","提示",MessageBoxButtons.OK ,MessageBoxIcon.Warning );
                            return;
                        }

                        frmOpertor frm = new frmOpertor();//经营户窗口
                        frm._market = CheckDatas.Rows[CheckDatas.CurrentCell.RowIndex].Cells[CheckDatas.CurrentCell.ColumnIndex - 1].Value.ToString();
                        frm.ShowDialog();
                        if(frm._Opertor !="")
                        {
                            CheckDatas.CurrentCell.Value = frm._Opertor;
                            cmbDetectUnitNature.Visible = false;
                        }
                    }
