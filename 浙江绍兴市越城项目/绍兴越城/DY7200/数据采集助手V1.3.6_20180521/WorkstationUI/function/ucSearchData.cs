    ...
    public partial class ucSearchData : UserControl
    {
        ...
        private void DataGridViewModefile()
        {
            if (CheckDatasdd.Rows.Count > 0)
            {
                ...
                CheckDatasdd.Columns["ItemName"].HeaderText = "匹配项目";
                CheckDatasdd.Columns["ItemCode"].HeaderText = "匹配项目编号";
                CheckDatasdd.Columns["Opertorname"].HeaderText = "经营户";
                CheckDatasdd.Columns["operatorCode"].HeaderText = "经营户编号";
                CheckDatasdd.Columns["stallNumber"].HeaderText = "摊位号";
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            //                MatchItems = dgvr.Cells["ItemName"].Value.ToString(),
            //                MatchItemsCode = dgvr.Cells["ItemCode"].Value.ToString(),
            //                Opertor = dgvr.Cells["Opertorname"].Value.ToString(),
            //                OpertorCode = dgvr.Cells["operatorCode"].Value.ToString(),
            //                StallNum = dgvr.Cells["stallNumber"].Value.ToString(),
            ...
            //                    P_ws.Cells[i + 2, 39] = RD[i].MatchItems .ToString();
            //                    P_ws.Cells[i + 2, 40] = RD[i].MatchItemsCode .ToString();
            //                    P_ws.Cells[i + 2, 41] = RD[i].Opertor .ToString();
            //                    P_ws.Cells[i + 2, 42] = RD[i].OpertorCode .ToString();
            //                    P_ws.Cells[i + 2, 43] = RD[i].StallNum .ToString();
            ...
            //                MatchItems =  CheckDatasdd.SelectedRows[k].Cells["ItemName"].Value.ToString(),
            //                MatchItemsCode = CheckDatasdd.SelectedRows[k].Cells["ItemCode"].Value.ToString(),
            //                Opertor = CheckDatasdd.SelectedRows[k].Cells["Opertorname"].Value.ToString(),
            //                OpertorCode = CheckDatasdd.SelectedRows[k].Cells["operatorCode"].Value.ToString(),
            //                StallNum = CheckDatasdd.SelectedRows[k].Cells["stallNumber"].Value.ToString(),
        ...
        private void btnLoadExcel_Click(object sender, EventArgs e)
        {
                ...
                if (openFileDialog1.ShowDialog() == DialogResult.OK)//判断是否选择了文件
                {
                    ...
                    if (dtExcel != null && dtExcel.Rows.Count > 0)
                    {
                        for (int i = 0; i < dtExcel.Rows.Count; i++)
                        {
                            ...
                            InData.MatchItems = dtExcel.Rows[i]["匹配项目"].ToString();
                            InData.MatchItemsCode = dtExcel.Rows[i]["匹配项目编号"].ToString();
                            InData.Operator = dtExcel.Rows[i]["经营户"].ToString();
                            InData.OperatorCode = dtExcel.Rows[i]["经营户编号"].ToString();
                            InData.stallnum = dtExcel.Rows[i]["摊位号"].ToString();
                            InData.Tester = dtExcel.Rows[i]["检测员"].ToString();
                            InData.Instrument = dtExcel.Rows[i]["检测仪器"].ToString();

                            //InData.Save = dtExcel.Rows[i]["已保存"].ToString();//是否已保存
                            //InData.Instrument = dtExcel.Rows[i]["检测仪器"].ToString();
                            ...
                            //InData.Addr = dtExcel.Rows[i]["样品产地"].ToString();
            ...
            //            InData.MatchItems = myds.Tables[0].Rows[r]["匹配项目"].ToString();
            //            InData.MatchItemsCode = myds.Tables[0].Rows[r]["匹配项目编号"].ToString();
            //            InData.Operator = myds.Tables[0].Rows[r]["经营户"].ToString();
            //            InData.OperatorCode = myds.Tables[0].Rows[r]["经营户编号"].ToString();
            //            InData.stallnum = myds.Tables[0].Rows[r]["摊位号"].ToString();
