...
namespace WorkstationModel.Model
{
    ...
    ///}   
    ///</summary>  
    public class clsMessageNotify
    {
        /// <summary>
        /// 消息自身实例
        /// </summary>
        private static clsMessageNotify _mNotify = null;
        ...
        /// </summary>
        /// <returns></returns>
        public static clsMessageNotify Instance()
        {
            if (_mNotify == null)
            {
                _mNotify = new clsMessageNotify();
            }
            return _mNotify;
        }
