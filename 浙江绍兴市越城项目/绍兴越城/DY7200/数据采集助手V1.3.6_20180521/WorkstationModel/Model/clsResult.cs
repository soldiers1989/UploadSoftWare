...
namespace WorkstationModel.Model
{
    ...
    public class clsResult
    {
        ...
        //辽宁
        private string _agri_name = string.Empty;
        private string _agri_small_type = string.Empty;
        private string _auth_variety = string.Empty;
        private string _monitor = string.Empty;
        private string _type_status = string.Empty;
        ...
        /// 辽宁-蔬菜名称编码
        /// </summary>
        public string agri_name
        {
            set { _agri_name = value; }
            get { return _agri_name; }
        }

        /// <summary>
        /// 辽宁-蔬菜类别编码
        /// </summary>
        public string agri_small_type
        {
            set { _agri_small_type = value; }
            get { return _agri_small_type; }
        }

        /// <summary>
        /// 辽宁-农产品认证种类
        /// </summary>
        public string auth_variety
        {
            set { _auth_variety = value; }
            get { return _auth_variety; }
        }
