...
namespace WorkstationDAL.Basic
{
    public class clsSaveResult
    {
        ...
        private string _instrumentNum = string.Empty;
        /// <summary>
        /// 仪器编号
        /// </summary>
        public string InstrumentNum
        {
            get
            {
                return _instrumentNum;
            }
            set
            {
                _instrumentNum = value;
            }
        }
        ...
        private string _Xiguagndu = "";
        /// <summary>
        /// 吸光度
        /// </summary>
        public string Xiguagndu
        {
            set
            {
                _Xiguagndu = value;
        ...
        private string _MatchItemsCode = "";
        /// <summary>
        /// 匹配项目编号
        /// </summary>
        public string MatchItemsCode
        {
            set
            {
                _MatchItemsCode = value;
            }
            get
            {
                return _MatchItemsCode;
            }
        }
        private string _Opertor = "";
        /// <summary>
        /// 经营户
        /// </summary>
        ...
        private string _OpertorCode = "";
        /// <summary>
        /// 经营户编号
        /// </summary>
        public string OpertorCode
        {
            set
            {
                _OpertorCode = value;
