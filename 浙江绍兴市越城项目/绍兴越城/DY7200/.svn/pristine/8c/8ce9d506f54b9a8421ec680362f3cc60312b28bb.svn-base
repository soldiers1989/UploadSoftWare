    ...
    public class clsMachineOpr
    {
        ...
        public DataTable GetAsDataTable(string whereSql, string orderBySql, int type)
        {
            ...
            try
            {
                ...
                {
                    sb.Append("SELECT Name,Manufacturer,communication,ChkStdCode FROM Instrument");
                }
        ...
        public static void GetDY5000()
        {
            ...
            try
            {
                ...
                {
                    clsShareOption.DY5000Name = "DY5000";
                }
                else if (obj.ToString().Equals("RS232DY5000LD"))
                {
                    clsShareOption.DY5000Name = "DY5000LD";
                }
                else
                {
                    clsShareOption.DY5000Name = string.Empty;
                }
            }
            catch (Exception e)
            {
        ...
        public static void GetDY3000()
        {
            ...
            try
            {
                ...
                {
                    clsShareOption.CurDY3000Tag = "DY3000DY";
                }
                else if (o.ToString().Equals("RS232DY3000"))
                {
                    clsShareOption.CurDY3000Tag = "DY3000";
                }
                else
                {
                    clsShareOption.CurDY3000Tag = string.Empty;
                }
            }
            catch (Exception e)
            {
