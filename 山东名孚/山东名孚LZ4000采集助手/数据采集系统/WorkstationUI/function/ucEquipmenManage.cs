    ...
    public partial class ucEquipmenManage : UserControl
    {
                ...
                try
                {
                    ...
                    if (dt != null)
                    {
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            {
                                addpublictable( dt.Rows[i][5].ToString(), dt.Rows[i][0].ToString(), dt.Rows[i][1].ToString(), dt.Rows[i][2].ToString());
                            }
                        }
            ...
            if (dr == DialogResult.Yes)
            {
                    ...
                    try
                    {
                        ...
                        {                                                    
                            ...
                            sb.Append(CheckDatas.SelectedRows[i].Cells[4].Value.ToString());
                            sb.Append("'");
        ...
        private void btnrepair_Click(object sender, EventArgs e)
        {
            if (Global.userlog != "sakj")//普通用户
            {
                ...
                {
                    Global.ediIntrument[0, 0] = CheckDatas.SelectedRows[0].Cells[0].Value.ToString();
                    Global.ediIntrument[0, 1] = CheckDatas.SelectedRows[0].Cells[1].Value.ToString();
                    Global.ediIntrument[0, 2] = CheckDatas.SelectedRows[0].Cells[2].Value.ToString();
                    Global.ediIntrument[0, 3] = CheckDatas.SelectedRows[0].Cells[3].Value.ToString();
                    string err = string.Empty;
                    StringBuilder sb = new StringBuilder();
                    sb.Length = 0;
                    ...
                    if (dt != null)
                    {
                        if (dt.Rows.Count > 0)
                        {
                            Global.ediIntrument[0, 4] = dt.Rows[0][7].ToString();
                        }
                    }
                    ...
                    if (dt != null)
                    {
                        ...
                        {
                            string d = dtc.Rows[i][3].ToString();
                            if (dtc.Rows[i][3].ToString() == "是")
                            {
                                addpublictable(dtc.Rows[i][5].ToString(), dtc.Rows[i][0].ToString(), dtc.Rows[i][1].ToString(), dtc.Rows[i][2].ToString());
                            }
                        }
                        CheckDatas.DataSource = spectable;
                        this.CheckDatas.Columns[0].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            ...
            else
            {
                try
                {
                    Global.ediIntrument[0, 0] = CheckDatas.SelectedRows[0].Cells[1].Value.ToString();
                    Global.ediIntrument[0, 1] = CheckDatas.SelectedRows[0].Cells[2].Value.ToString();
                    Global.ediIntrument[0, 2] = CheckDatas.SelectedRows[0].Cells[3].Value.ToString();
                    Global.ediIntrument[0, 3] = CheckDatas.SelectedRows[0].Cells[4].Value.ToString();
                    Global.ediIntrument[0, 4] = CheckDatas.SelectedRows[0].Cells[5].Value.ToString();
                    ...
                    if (dt != null)
                    {
                        if (dt.Rows.Count > 0)
                        {
                            Global.ediIntrument[0, 5] = dt.Rows[0][7].ToString();
                        }
                    }
        ...
        private void chkBoxMachine_MouseClick(object sender, MouseEventArgs e)
        {
            if (chkBoxMachine.Checked == true)
            {
                ...
                {
                    if (CheckDatas.Rows[i].Cells[0].Value.ToString() == "True" && sel ==false)//单击仅选一款仪器
                    {
                        CheckDatas.Rows[i].Cells[0].Value = true ;
                        sel = true;
                        try
                        {
                            sql.SetIntrument(CheckDatas.Rows[i].Cells[0].Value.ToString(), CheckDatas.Rows[i].Cells[1].Value.ToString(), out err);
                        }
                        catch (Exception ex)
                        {
                            MessageBox.Show(ex.Message, "Error");
                    ...
                    else if (CheckDatas.Rows[i].Cells[0].Value.ToString() == "True" && sel == true)
                    {
                        CheckDatas.Rows[i].Cells[0].Value = false;
