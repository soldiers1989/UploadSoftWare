    ...
    {   
        ...
        {  
           // this.WindowState = FormWindowState.Maximized;
            ...
            Global.DetectUnitNo = ConfigurationManager.AppSettings["UpDetectUnitNo"];      
        ...
        private  void labelSample_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            {
                dy.savediary(DateTime.Now.ToString(), "进入样品信息", "失败："+ex.Message);
            }
        }
        /// <summary>
        /// 检测单位与被检单位信息单击事件
        ...
        private void labelUnit_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            {
                dy.savediary(DateTime.Now.ToString(), "进入机构信息", "失败："+ex.Message);
                throw ex;
            }
        }
        ...
        private void labDataReturn_Click(object Sender, MouseEventArgs e)
        {
            ...
            {
                dy.savediary(DateTime.Now.ToString(), "进入数据恢复", "失败："+ex.Message);
                throw ex;
            }
        }     
        ...
        private void labDataManage_Click(object Sender, MouseEventArgs e)
        {
            try
            {
                ...
                if (dlg == DialogResult.OK)
                {
                    ...
                    {
                        dy.savediary(DateTime.Now.ToString(), "数据库备份", "失败：" + ex.Message);
            ...
            {
                dy.savediary(DateTime.Now.ToString(), "进入数据备份", "失败："+ex.Message);
                throw ex;
            }
        }
        ...
        private void labStatistical_Click(object Sender, MouseEventArgs e)
        {
            ...
            {
                dy.savediary(DateTime.Now.ToString(), "进入统计分析", "失败："+ex.Message);
                throw ex;
            }
        }
        //鼠标进入统计分析
        ...
        private void lbfindptint_Click(object Sender, MouseEventArgs e)
        {
            ...
            {
                dy.savediary(DateTime.Now.ToString(), "进入数据查询", "失败："+ex.Message);
                throw ex;
            }
        }
        /// <summary>
        ...
        private void PanelSysSet_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            {
                dy.savediary(DateTime.Now.ToString(), "进入系统设计菜单", "失败："+ex.Message);
                throw ex;
            }
        }
        ...
        private void labelSysUpdate_click(object Sender, MouseEventArgs e)
        {
            ...
            {
                dy.savediary(DateTime.Now.ToString(), "进入系统升级", "失败："+ex.Message);
                throw ex;
            }
        }
        ...
        private void labelDairy_click(object Sender, MouseEventArgs e)
        {
            ...
            {
                dy.savediary(DateTime.Now.ToString(), "查看操作日记", "失败："+ex.Message);
                throw ex;
            }
        }
        ...
        private void labelServer_click(object Sender, EventArgs e)
        {
            ...
            {
                dy.savediary(DateTime.Now.ToString(), "进入服务器配置", "失败："+ex.Message);
                throw ex;
            }
        }
        ...
        private void labeAbout_click(object Sender, MouseEventArgs e)
        {
            ...
            {
                dy.savediary(DateTime.Now.ToString(), "进入关于", "失败："+ex.Message);
                throw ex;
            }
        }
        ...
        private void labelHelp_click(object Sender, MouseEventArgs e)
        {
            ...
            {
                dy.savediary(DateTime.Now.ToString(), "进入帮助", "失败："+ex.Message);
                throw ex;
            }
        }
        ...
        private void labelUserManage_click(object Sender, MouseEventArgs e)
        {
            ...
            {
                dy.savediary(DateTime.Now.ToString(), "用户管理", "失败：" + ex.Message);
                throw ex;
            }
        }
        /// <summary>
        ...
        private void labSysSet_click(object Sender, MouseEventArgs e)
        {
            ...
            {
                dy.savediary(DateTime.Now.ToString(), "进入仪器管理", "失败："+ex.Message);
                throw ex;
            }
        }
        //鼠标离开设计按钮
        ...
        private void labelclose_Click(object sender, EventArgs e)
        {
            ...
            {
                dy.savediary(DateTime.Now.ToString(), "系统退出", "失败："+ex.Message );
                throw ex;
            }
        }
        ...
        private void pnlShop_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            {
                dy.savediary(DateTime.Now.ToString(), "进入商城菜单", "失败："+ ex.Message);
                throw ex;
            }
        }
