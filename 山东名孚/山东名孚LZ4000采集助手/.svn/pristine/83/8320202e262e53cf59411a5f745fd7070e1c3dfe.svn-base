...
//#endif
            tbx_user.Focus();
            this.tbx_user.Select(0, this.Txt_Password.Text.Length);
        ...
        private void Login_PreviewKeyDown(object sender, PreviewKeyDownEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                if (tbx_user.Text.Trim() != "sakj")
                {
                    ...
                    sb.Append("where userlog=");
                    sb.Append("'");
                    sb.Append(Txt_Password.Text.Trim());
                    sb.Append("'");
                    sb.Append(" order by ID");
                    ...
                    {
                        if (!dt.Rows[0][1].ToString().Equals(tbx_user.Text.Trim()))
                        {
                            MessageBox.Show("密码错误，请重新输入！", "提示", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            this.tbx_user.Text = "";
                            this.tbx_user.Focus();
                    ...
                    Global.userlog = Txt_Password.Text.Trim();
                    this.Hide();
                    this.ShowIcon = false;
                    MainForm window = new MainForm();
