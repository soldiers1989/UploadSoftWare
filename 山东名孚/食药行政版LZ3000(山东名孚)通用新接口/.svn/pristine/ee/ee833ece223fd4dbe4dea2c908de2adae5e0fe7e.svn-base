...
namespace DY.FoodClientLib.Model
{
    public class clsResultDL
    {
        ...
        private string _IsDestruction = "";
        private string _DestructionKG = "";
        ...
        private string _CheckTotalItemName = "";
        /// <summary>
        /// 检测项目名称
        /// </summary>
        public string CheckTotalItemName
        {
            set
            {
                _CheckTotalItemName = value;
            }
            get
            {
                return _CheckTotalItemName;
            }
        }
