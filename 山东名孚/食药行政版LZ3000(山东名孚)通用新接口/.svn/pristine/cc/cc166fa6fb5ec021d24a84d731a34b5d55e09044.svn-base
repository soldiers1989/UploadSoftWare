...
namespace FoodClient
{
    ...
    public partial class FrmBaseDataDownload : TitleBarBase
    {
        ...
        {                        
            ...
            Global.AnHuiInterface.instrumentNo = tb_instrumentNo.Text;
            Global.AnHuiInterface.instrument = tb_instrument.Text;
            Global.AnHuiInterface.barcode = txtbarcode.Text;
