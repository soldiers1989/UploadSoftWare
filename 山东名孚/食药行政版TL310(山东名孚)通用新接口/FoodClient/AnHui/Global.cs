...
namespace FoodClient.AnHui
{
    public class Global
    {
        ...
        /// false是选择旧接口
        /// </summary>
        public static bool setInterface = false;
        /// <summary>
        /// 同时上传新平台
        /// </summary>
        public static bool DoubleWeb = false;
        /// <summary>
        /// 服务器地址
        /// </summary>
        public static string WebAddr = string.Empty;
        /// <summary>
        /// 检测单位ID
        /// </summary>
        ...
        public static class AnHuiInterface
        {
            ...
            public static string barcode = ConfigurationManager.AppSettings["shangdongbarcode"];
