...
namespace FoodClient
{
    public partial class FrmAutoTakeDY : TitleBarBase
    {
        ...
        protected void BindInit()
        {
            ...
            txtChkUnitNum.Text = Global.AnHuiInterface.userName;//检测站编号
            #endregion
        }
        ...
        private bool checkValue()
        {
            try
            {
                ...
                //if (cmbProduceCompany.Text.Trim().Length == 0)
                //{
            ...
            if (checkValue())
            {
                ...
                try
                {
                   ...
                   // if (!string.IsNullOrEmpty(produceDate))
                    ...
                    model.CheckMachine = _machineCode;
                    model.HolesNum = txtHole.Text.Trim(); //lblHolesNum.Text;
            ...
            lock (this)
            {
                ...
                if (c1FlexGrid1.RowSel >= 1)
                {
                    ...
                    if (_tag != "DYRSY2" && _tag != "DY6400")//两款肉类水分仪除外
                    {
                        ...
                        txtCheckValueInfo_TextChanged(null, null);
                        return;
                    }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected virtual void btnRead_Click(object sender, EventArgs e)
        {
