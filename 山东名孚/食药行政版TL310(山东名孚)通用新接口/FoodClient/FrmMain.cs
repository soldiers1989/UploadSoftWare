...
namespace FoodClient
{
    ...
    public class FrmMain : System.Windows.Forms.Form
    {
        ...
        private ToolStripMenuItem 新接口设置ToolStripMenuItem;
        ...
        private void InitializeComponent()
        {
            ...
            this.新接口设置ToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            ...
            // 
            // 新接口设置ToolStripMenuItem
            // 
            this.新接口设置ToolStripMenuItem.Name = "新接口设置ToolStripMenuItem";
            this.新接口设置ToolStripMenuItem.Size = new System.Drawing.Size(192, 26);
            this.新接口设置ToolStripMenuItem.Text = "新接口设置";
            this.新接口设置ToolStripMenuItem.Click += new System.EventHandler(this.新接口设置ToolStripMenuItem_Click);
            // 
            // taizhanMngTSMI
            // 
        ...
        private void frmMain_Load(object sender, System.EventArgs e)
        {
            ...
            checkPointMngTSMI.Visible = true;
            beCheckUnitMngTSMI.Visible = true;
            producerUnitMngTSMI.Visible = true;
            //checkPointTypeMngTSMI.Visible = true;

            //checkItemMngTSMI.Visible = true;
            foodClassMngTSMI.Visible = true;
            //checkTypeMngTSMI.Visible = true;
            toolStripSeparator5.Visible = true;
            orgMngTSMI.Visible = true;
            //checkPointTypeMngTSMI.Visible = true;
            checkPointMngTSMI.Visible = true;
            toolStripSeparator6.Visible = true;
            //unitTypeMngTSMI.Visible = true;
            beCheckUnitMngTSMI.Visible = true;
            producerUnitMngTSMI.Visible = true;
            //producePlaceMngTSMI.Visible = true;
            TsSeparatorDownload.Visible = true;
            baseDataDownloadTSMI.Visible = true;
            ...
            string Interface = System.Configuration.ConfigurationManager.AppSettings["setInterface"];
            if (Interface == "xin")
            {
                FoodClient.AnHui.Global.setInterface = true ;
            }
            else
            {
                FoodClient.AnHui.Global.setInterface = false;
            }
            string doubleweb = System.Configuration.ConfigurationManager.AppSettings["DoubleWebserverice"];
            if (doubleweb == "1")
            {
                FoodClient.AnHui.Global.DoubleWeb = true;
            }
            else
            {
                FoodClient.AnHui.Global.DoubleWeb = false;
            }
        ...
        public void Auto_TL310()
        {
            machineAutoDYSeries("TL310");
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void 新接口设置ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Basic.frmNewInterface window = new Basic.frmNewInterface();
            window.ShowDialog();
        }
