	...
	public class clsResultOpr
	{
        ...
        public int InsertSZ(clsResult model, out string errMsg)
        {
            ...
            try
            {
                ...
                _strBd.Append("IsSentCheck,CheckederRemark,Notes, HolesNum,MachineSampleNum,MachineItemName,SampleSource,Contact,ContactPhone,IsDestruction,DestructionKG,Area,SampleAmount,barcode)");
                _strBd.Append("VALUES('");
                _strBd.Append(model.SysCode);
                _strBd.Append("','");
