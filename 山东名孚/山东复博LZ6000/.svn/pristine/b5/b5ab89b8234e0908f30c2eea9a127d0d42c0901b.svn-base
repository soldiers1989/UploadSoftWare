...
{
    public partial class DLReportForm : Form
    {
        ...
        /// <param name="e"></param>
        private void TSMeuExit_Click(object sender, EventArgs e)
        {
            webBrowser1.Dispose();
            this.Close();
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void TSMeuPrint_Click(object sender, EventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void TSMeuPrintPreview_Click(object sender, EventArgs e)
        {
            webBrowser1.ShowPrintPreviewDialog();
            webBrowser1.Invalidate();
        }

        private void DLReportForm_Load(object sender, EventArgs e)
        {
