...
namespace FoodClient
{
    ...
    public class FrmMain : System.Windows.Forms.Form
    {
        ...
        private ToolStripMenuItem 检测单位同步ToolStripMenuItem;
        ...
        private void InitializeComponent()
        {
            ...
            this.检测单位同步ToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            ...
            // 
            // 检测单位同步ToolStripMenuItem
            // 
            this.检测单位同步ToolStripMenuItem.Name = "检测单位同步ToolStripMenuItem";
            this.检测单位同步ToolStripMenuItem.Size = new System.Drawing.Size(192, 26);
            this.检测单位同步ToolStripMenuItem.Text = "检测单位同步";
            this.检测单位同步ToolStripMenuItem.Click += new System.EventHandler(this.检测单位同步ToolStripMenuItem_Click);
            // 
            // FrmMain
            // 
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void 检测单位同步ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            FrmUnitSynchronize window = new FrmUnitSynchronize();
            window.ShowDialog();
        }
