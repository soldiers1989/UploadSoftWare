...
{
    public partial class ucDY6400 : BasicContent
    {
        ...
        private void ucDY6400_Load(object sender, EventArgs e)
        {
        ...
        private void showOnControl(DataTable dtbl)
        {
            ...
            //if (CheckDatas.Cols["已保存"] != null)
            //{
            //    CheckDatas.Cols["已保存"].Style.BackColor = Color.LightGray;
            //    CheckDatas.Cols["已保存"].AllowDragging = false;
            //}
            BtnReadHis.Enabled = true;
            BtnClear.Enabled = true;
