...
namespace WorkstationUI.machine
{
    public partial class UControl_LZ4000 :BasicContent
    {
        ...
        //    for (int i = 0; i<CheckDatas.Rows.Count; i++)
        //    {
        //        resultdata.Gridnum=CheckDatas.Rows[i].Cells[0].Value.ToString ();
        //        resultdata.Checkitem = CheckDatas.Rows[i].Cells[1].Value.ToString();
        //        resultdata.SampleName = CheckDatas.Rows[i].Cells[2].Value.ToString();
        //        resultdata.CheckData = CheckDatas.Rows[i].Cells[3].Value.ToString();
        //        resultdata.Unit = CheckDatas.Rows[i].Cells[4].Value.ToString();
        //        resultdata.CheckTime = CheckDatas.Rows[i].Cells[5].Value.ToString();
        //        resultdata.CheckUnit = CheckDatas.Rows[i].Cells[6].Value.ToString();              
