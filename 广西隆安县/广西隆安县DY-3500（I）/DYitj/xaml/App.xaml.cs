...
namespace AIO
{
    ...
    public partial class App : Application
    {
        private void Application_Startup(object sender, StartupEventArgs e)
        {
            ...
            {
                PrintHelper.IsInstrumentName = Global.Printing[0].PrintInstrumentName;
                PrintHelper.IsCompany = Global.Printing[0].PrintCompany;
                PrintHelper.IsItemCategory = Global.Printing[0].PrintItemCategory;
                PrintHelper.IsDate = Global.Printing[0].PrintDate;
                PrintHelper.IsUnit = Global.Printing[0].PrintUnit;
                PrintHelper.IsUser = Global.Printing[0].PrintUser;
                PrintHelper.IsReviewers = Global.Printing[0].PrintReviewers;
                PrintHelper.IsPrintCode = Global.Printing[0].PrintQR;
            }
        }
