...
namespace AIO
{
    ...
    public partial class FgdEditItemWindow : Window
    {
            ...
            try
            {
                ...
                if (null != _item)
                {
                    ...
                    else if (1 == _MethodToIndex[_item.Method])
                    {
                        ...
                        Btn_CalculatedCurve.Visibility = Visibility.Collapsed ;
                    }
        ...
        private void ComboBoxMethod_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            _isUpdate = true;
            //标准曲线法
            Btn_CalculatedCurve.Visibility = ComboBoxMethod.SelectedIndex == 1 ? Visibility.Collapsed : Visibility.Collapsed;
        }
