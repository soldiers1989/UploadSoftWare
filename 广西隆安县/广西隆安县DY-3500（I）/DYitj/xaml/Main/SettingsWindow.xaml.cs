    ...
    public partial class SettingsWindow : Window
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (Global.samplenameadapter.Count > 0)
                {
                    ...
                    textBoxDeviceID.Text = CPoint.serial;
                    textDeviceType.Text = CPoint.mechineType;
                }
        ...
        private void SaveSetting()
        {
            try
            {
                ...
                CPoint.url = textBoxServerAddr.Text.Trim();
                CPoint.user = textBoxRegisterID.Text.Trim();
                CPoint.pwd = textBoxRegisterPassword.Password.Trim();
                CPoint.pointNum = textBoxCheckNumber.Text.Trim();
                CPoint.pointName = textBoxCheckName.Text.Trim();
                CPoint.pointType = textBoxCheckType.Text.Trim();
                CPoint.orgName = textBoxCheckOrg.Text.Trim();
                CPoint.orgNum = textCheckPlaceCode.Text.Trim();
                CPoint.nickName = textBoxRegisterID.Text.Trim();
                CPoint.userId = Global.userId;
                CPoint.pointId = Global.pointId;
                CPoint.serial = textBoxDeviceID.Text.Trim();
                CPoint.mechineType = textDeviceType.Text.Trim();
        ...
        private void ButtonServerTest_Click(object sender, RoutedEventArgs e)
        {
            ...
            Message msg = new Message()
            {
                ...
                str4 = textBoxDeviceID.Text.Trim(),
                str5 = textDeviceType.Text.Trim(),
            };
            Global.workThread.SendMessage(msg, _msgThread);
        }
