...
namespace AIO
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void ButtonZjs_Click(object sender, RoutedEventArgs e)
        {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                //薄层色谱
                if (!_userconfig.UIFaceBcsp || !Global.IsEnableBcsp)
                {
                    wp_bcsp.Visibility = Visibility.Collapsed;
                    Global.set_IsOpenSxt = false;
                }
                ...
                //荧光免疫
                if (!_userconfig.UIFaceYgmy || !Global.IsEnableYgmy)
                {
                    wp_yg.Visibility = Visibility.Collapsed;
                    Global.set_IsOpenSxt = false;
                }
                ...
                //食源性微生物
                if (!_userconfig.UIFaceSyxwsw || !Global.IsEnableSyxwsw)
                {
                    wp_syxwsw.Visibility = Visibility.Collapsed;
                    Global.set_IsOpenSxt = false;
                }
