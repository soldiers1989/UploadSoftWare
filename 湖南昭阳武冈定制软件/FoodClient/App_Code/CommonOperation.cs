...
namespace DY.FoodClientLib
{
    ...
    public class CommonOperation
    {
        ...
        public static void GetMachineSetting(string machinModel)
        {
            ...
            else if (machinModel.IndexOf("0DY") > 0 || machinModel.IndexOf("IDY") > 0 || machinModel.IndexOf("VDY") > 0)//如果是新版DY3000(后有DY)系列与旧版DY3000区分
            {
                temp = "DY3000DY";
                if (machinModel.Equals("LZ3000DY") || machinModel.Equals("LZ6000DY") || machinModel.Equals("DY6600DY"))
                {
                    query = string.Format("Protocol='RS232{0}' AND MachineModel='{1}'", temp, machinModel.Substring(0, machinModel.Length - 2));
                }
                else
                {
            ...
            else if (machinModel.IndexOf("0LD") > 0 || machinModel.IndexOf("ILD") > 0)//如果是雷度系列版本如:DY5000LD,DY5500LD
            {
                temp = "DY5000LD";
            ...
            #region 注掉
            /* 
            * 2012-06-21 修改下面这种方式扩展性不灵活，若新增加
            * switch (machinModel)//仪器型号
            {
              
                //case "clsDYPR6C":
                //    strQuery = "Protocol='RS232农残仪插件'";
                //    break;
                //case "clsJD106SC":
                //    strQuery = "Protocol='吉大小天鹅106农残仪插件'";
                //    break;
                //case "clsJD801SC":
                //    strQuery = "Protocol='吉大小天鹅801二氧化硫检测仪插件'";
                //    break;
                //case "clsJD901SC":
                //    strQuery = "Protocol='吉大小天鹅901亚硝酸盐检测仪插件'";
                //    break;
                //case "clsDY3000I":
                //    strQuery = "Protocol='RS232DY3000I'";
                //    break;

                //协议部分去掉"综合仪插件"字串 2011-06-16，目的是为了字符串匹配更快
                //strDllName去前缀“cls”,更加直观

                case "DYRSY2":
                    query = "Protocol='RS232水分仪插件' AND MachineModel='DYRSY2'";
                    break;

                //新版DY3000/DY2000/DY1000都是用DY300DY协议后缀多了"DY"
                case "DY3900DY":
                    query = "Protocol='RS232DY3000DY' AND MachineModel='DY3900'";
                    break;

                case "DY3000DY":
                    query = "Protocol='RS232DY3000DY' AND MachineModel='DY3000'";
                    break;

                case "DY2000DY":
                    query = "Protocol='RS232DY3000DY' AND MachineModel='DY2000'";
                    break;

                case "DY1000DY":
                    query = "Protocol='RS232DY3000DY' AND MachineModel='DY1000'";
                    break;

                //旧版DY5000 注意协议后缀不同 
                case "DY5000":
                    query = "Protocol='RS232DY5000' AND MachineModel='DY5000'";
                    break;

                //旧版DY3000  也是雷度公司的
                case "DY3000":
                    query = "Protocol='RS232DY3000' AND MachineModel='DY3000'";
                    break;

                case "DY5000LD"://雷度版DY5000,称为相对新版DY5000系列
                    query = "Protocol='RS232DY5000LD' AND MachineModel='DY5000'";
                    break;

                case "DY5500LD"://DY5500
                    query = "Protocol='RS232DY5000LD' AND MachineModel='DY5500'";
                    break;

                case "DY5600LD"://DY5600
                    query = "Protocol='RS232DY5000LD' AND MachineModel='DY5600'";
                    break;

                case "DY5800LD"://DY5800
                    query = "Protocol='RS232DY5000LD' AND MachineModel='DY5800'";
                    break;

                case "DY4300LD"://DY4300
                    query = "Protocol='RS232DY5000LD' AND MachineModel='DY4300'";
                    break;

                case "DY6100"://DY6100
                    query = "Protocol='RS232DY6100' AND MachineModel='DY6100'";
                    break;

                case "DY6200"://DY6200
                    query = "Protocol='RS232DY6200' AND MachineModel='DY6200'";
                    break;

                case "DY6400"://DY6400
                    query = "Protocol='RS232DY6400' AND MachineModel='DY6400'";
                    break;

                case "DY8120"://DY8120
                    query = "Protocol='RS232DY8120' AND MachineModel='DY8120'";
                    break;
            }
            * */
            #endregion
            ...
            else
            {
                ...
                //{
                //    if (Convert.ToBoolean(dtbl.Rows[i]["IsSupport"]) || (i == 0))
                //    {
                //        ShareOption.DefaultMachineCode = dtbl.Rows[i]["SysCode"].ToString();
                //        ShareOption.DefaultCheckItemCode = dtbl.Rows[i]["LinkStdCode"].ToString();
                //        ShareOption.ComPort = "COM" + dtbl.Rows[i]["LinkComNo"].ToString() + ":";
                ...
                //    }
                //}
                //ShareOption.SysCurMachine = strDllName;
                #endregion
            }
        }
        ...
        public static void GetTitleSet()
        {
            ...
            ShareOption.DomainTitle = "门牌号";// "档口/店面/车牌号";
        ...
        public static string DownloadAll(string stdCode, string districtCode, out string sumError, string sign)
        {
            ...
            {
                // MessageBox.Show("同步数据失败，失败原因："+ e.Message);
        ...
        public static void GetSystemInfo()
        {
            ...
            //DataTable dt = curObjectOpr.GetAsDataTable("SysCode Like '______'", "SysCode");//'______'表示位数长度
