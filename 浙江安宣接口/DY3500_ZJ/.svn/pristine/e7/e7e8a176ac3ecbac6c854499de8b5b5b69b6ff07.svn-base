...
namespace AIO
{
    public class Wisdom
    {
        ...
        public static Boolean ISUPLOADSAMPLE = false;
        ...
        public static Boolean ISUPLOADRESULT = false;
        ...
        private static String getParamaters(String PostType)
        {
            String strUSER = USER.Length > 0 ? USER 
                : (LoginWindow._curAccount == null ? "admin" : LoginWindow._curAccount.UserName);
            String strPWD = PASSWORD.Length > 0 ? PASSWORD 
                : (LoginWindow._curAccount == null ? "admin" : LoginWindow._curAccount.UserPassword);
        ...
        /// <returns></returns>
        public static Boolean UploadDeviceStatus()
        {
            try
            {
