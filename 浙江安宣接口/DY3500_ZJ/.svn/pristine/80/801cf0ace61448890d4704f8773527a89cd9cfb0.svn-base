...
namespace AIO
{
    ...
    {   
        ...
        public static string sampleName = string.Empty, projectName = string.Empty, projectUnit = string.Empty, itenName = string.Empty, itemCode = string.Empty;
        /// <summary>
        /// 存储样品小精灵是否从项目名称弹出
        /// </summary>
        ...
        /// 
        /// </summary>
        public static Boolean IsSelectProject = false;
        ...
        /// </summary>
        /// <returns></returns>
        public static string CommunicationTest(string uri,string user,string pwd)
        {
            string cookie = "";
            try
            {
                ...
                string url = Global.geturl(uri, 1);
                //string url = "http://www.anxuan360.com:9091/open/api/farm/login";
        ...
        public static int ProjectItem = 0;
        public static string ZJMeserr = string.Empty;
        public struct GetData
        {
            public int ID { get; set; }  //属性的名字，必须与json格式字符串中的"key"值一样。
        ...
        /// 浙江即时上传1条记录
        /// </summary>
        public static Boolean  UpNowOne = false ;
