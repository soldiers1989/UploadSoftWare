...
namespace AIO
{
    ...
    public partial class MainWindow : Window
    {
        ...
        /// 是否需要上传数据到广东省智慧平台
        /// </summary>
        private bool InterfaceType = (Global.InterfaceType.Equals("ZH") || Global.InterfaceType.Equals("ALL")) ? true : false;
        ...
        public MainWindow()
        {
            ...
            //t = new System.Timers.Timer(200000);
        ...
        private void DownTaskQuick()
        {
            TestResultConserve tsr = new TestResultConserve();
            tsr.DownTaskMain();
        }
