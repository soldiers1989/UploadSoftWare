...
namespace AIO
{
    ...
    public partial class SettingsWindow : Window
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            try
            {
                if (Global.EachDistrict.Equals("GS"))
                {
                    ...
                    buttonCehckSync.Content = "全部数据下载";
        ...
        class MsgThread : ChildThread
        {
            ...
            public void UIHandleMessage(Message msg)
            {
                switch (msg.what)
                {
                    ...
                    case MsgCode.MSG_CHECK_SYNC:   //下载检测项目
                        ...
                        try
                        {
                            ...
                            if (msg.result == true)
                            {
                                MessageBox.Show("数据下载成功!\r\n\r\n" + "共成功下载" + msg.CheckItems + "条记录\r\n" + "失败" + msg.CheckItemsTempList + "条记录", "操作提示", MessageBoxButton.OK, MessageBoxImage.Information);
                                wnd.ChangeCehckSync(true, "检测项目下载", 20);
                            }
        ...
        private void Btn_SaveDeviceId_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (str.Length == 0)
            {
                MessageBox.Show(this, "设备唯一码不能为空!", "系统提示");
                tb_DeviceId.Focus();
                return;
            }
            ...
            MessageBox.Show(this, "唯一机器码设置成功!");
        ...
        private void RepairProjects()
        {
            //检测结果表ttResultSecond新增字段
            try
            {
                string err = string.Empty;
            ...
            {
                MessageBox.Show("修复成功！", "系统提示", MessageBoxButton.OK, MessageBoxImage.Asterisk);
            }
        }
        ...
        private void buttonCehckSyncD_Click(object sender, RoutedEventArgs e)
        {
