...
namespace AIO
{
    ...
    public partial class LoginWindow : Window
    {
        ...
        public static UserAccount _curAccount;
        ...
        {
            //string url = "http://www.anxuan360.com:9091/open/api/farm/login", json = "username=test_dy&password=test_dy";
            //Global.HttpMath("POST", url, json);      
            //return;
            Login();
        }
