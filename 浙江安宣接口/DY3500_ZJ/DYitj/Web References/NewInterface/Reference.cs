...
namespace AIO.NewInterface {
    ...
    public partial class dataSync : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback loadSamplingDataOperationCompleted;
        ...
        /// <remarks/>
        public event loadSamplingDataCompletedEventHandler loadSamplingDataCompleted;
        ...
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("", RequestNamespace="http://face.webservice.fsweb.excellence.com", ResponseNamespace="http://face.webservice.fsweb.excellence.com", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        [return: System.Xml.Serialization.XmlElementAttribute("out", IsNullable=true)]
        public string loadSamplingData([System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] string in0, [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] string in1, [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] string in2) {
            object[] results = this.Invoke("loadSamplingData", new object[] {
                        in0,
                        in1,
                        in2});
            return ((string)(results[0]));
        ...
        /// <remarks/>
        public void loadSamplingDataAsync(string in0, string in1, string in2) {
            this.loadSamplingDataAsync(in0, in1, in2, null);
        }
        
        /// <remarks/>
        public void loadSamplingDataAsync(string in0, string in1, string in2, object userState) {
            if ((this.loadSamplingDataOperationCompleted == null)) {
                this.loadSamplingDataOperationCompleted = new System.Threading.SendOrPostCallback(this.OnloadSamplingDataOperationCompleted);
            }
            this.InvokeAsync("loadSamplingData", new object[] {
                        in0,
                        in1,
                        in2}, this.loadSamplingDataOperationCompleted, userState);
        }
        
        private void OnloadSamplingDataOperationCompleted(object arg) {
            if ((this.loadSamplingDataCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.loadSamplingDataCompleted(this, new loadSamplingDataCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1586.0")]
    public delegate void loadSamplingDataCompletedEventHandler(object sender, loadSamplingDataCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1586.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class loadSamplingDataCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal loadSamplingDataCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
