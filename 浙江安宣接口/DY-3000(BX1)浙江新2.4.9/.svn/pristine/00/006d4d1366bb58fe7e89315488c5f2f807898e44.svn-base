...
namespace AIO.src
{
    ...
    {
        public static List<string> UpdateSql()
        {
            List<string> sqlList = new List<string>();
            //检测项目表
            sqlList.Add("create table ZJCheckItem(ID integer identity(1,1) PRIMARY KEY)");//创建表
            sqlList.Add("alter table ZJCheckItem add itemName varchar(255)");//新增列
            sqlList.Add("alter table ZJCheckItem add itemCode varchar(255)");
            ...
            sqlList.Add("alter table ttResultSecond add ItemCode varchar(255)");
