    ...
    public partial class FgdSelChannelWindow : Window
    {
        ...
        private void ButtonNext_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                //{
                //    if (Double.MinValue == _item.dn.dnn)
                //        MessageBox.Show(this, "当前检测项目需要进行对照测试!", "系统提示", MessageBoxButton.OK, MessageBoxImage.Warning);
                //}
                //else if (4 == _item.Method)
                //{
                //    if (Double.MinValue == _item.co.coeff )
                //        MessageBox.Show(this, "当前检测项目需要进行对照测试!", "系统提示", MessageBoxButton.OK, MessageBoxImage.Warning);
                //}
                ...
                for (i = 0; i < Global.deviceHole.HoleCount; ++i)
                {
                    if (_item.Hole[i].Use)
                    {
                        listSampleName[i].Text = (_item.Method == 0 && Double.MinValue != _item.ir.RefDeltaA) ||
                            (_item.Method == 1 && Double.MinValue != _item.sc.RefA) || (_item.Method == 3 && Double.MinValue != _item.dn.DetTime) || (_item.Method == 4 && Double.MinValue != _item.co.HLevel) ? string.Empty : "对照样";    
                            //(_item.Method == 3 && Double.MinValue != _item.dn.DetTime) || (_item.Method ==4 && Double.MinValue != _item.co.HLevel) 
                        break;
                    }
                }
