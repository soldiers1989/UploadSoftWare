    ...
    public partial class FgdWindow : Window
    {
        ...
        private void ButtonEditItem_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    FgdEditItemWindow window = new FgdEditItemWindow();
                    window._item = Global.fgdItems[_SelIndex];
                    window.ShowInTaskbar = false; window.Owner = this; window.ShowDialog();
        ...
        private void ShowSample()
        {
            ...
            else
            {
                ...
                searchSample._projectName = Global.fgdItems[_SelIndex].Name;
        ...
        private void ShowBorder(object sender, MouseButtonEventArgs e, string type)
        {
            try
            {
                ...
                List<TextBox> tbpoject = UIUtils.GetChildObjects<TextBox>(WrapPanelItem, "project");  
