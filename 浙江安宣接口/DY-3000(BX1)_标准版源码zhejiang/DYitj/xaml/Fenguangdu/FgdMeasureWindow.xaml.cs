    ...
    public partial class FgdMeasureWindow : Window
    {
        ...
        private void Initial()
        {
            try
            {
                ...
                this.ButtonSampleTest.IsEnabled = (_item.Method == 0) ? ((_item.ir.RefDeltaA == Double.MinValue) ? false : true) : ((_item.Method == 1 && _item.sc.RefA == Double.MinValue) ? false : 
                    ((_item.Method == 3 && _item.dn.dnn == Double.MinValue)?false :((_item.Method == 4 && _item.co.coeff== Double.MinValue)?false :true)));
        ...
        private UIElement GenerateSampleMeasureForm(string channel, string sampleNum, string sampleName)
        {
            ...
            try
            {
                ...
                labelChannel.Width = 60;
                labelChannel.Name = "channel";
                labelChannel.HorizontalContentAlignment = System.Windows.HorizontalAlignment.Center;
                ...
                labelSampleNum.Name = "sampleNum";
                labelSampleNum.HorizontalContentAlignment = System.Windows.HorizontalAlignment.Center;
                ...
                labelSampleName.Name = "sampleName";
                labelSampleName.ToolTip = sampleName;
                labelSampleName.HorizontalContentAlignment = System.Windows.HorizontalAlignment.Center;

                //吸光度
                Label labelXgd = new Label();
                labelXgd.Content = "0";
                labelXgd.FontSize = 20;
                labelXgd.Width = 100;
                labelXgd.Name = "xiguangdu";
                labelXgd.HorizontalContentAlignment = System.Windows.HorizontalAlignment.Center;

                //透光率
                Label labelTgl = new Label();
                labelTgl.Content = "100%";
                labelTgl.FontSize = 20;
                labelTgl.Width = 100;
                labelTgl.Name = "touguanglv";
                labelTgl.HorizontalContentAlignment = System.Windows.HorizontalAlignment.Center;

                //检测时间
                Label labelResult = new Label();
                labelResult.Content = "";
                labelResult.FontSize = 20;
                labelResult.Width = 100;
                labelResult.Name = "detectresult";
                labelResult.HorizontalContentAlignment = System.Windows.HorizontalAlignment.Center;
                Grid.SetColumn(labelResult, 5);

                //单通道检测
                Button separateTest = new Button();
                separateTest.Content = "样   品 " + channel;
                separateTest.FontSize = 20;
                separateTest.Width = 120;
                separateTest.Name = "separateTest";
                ...
                showCurve.Tag = channel;
                showCurve.Name = "showCurveTest";
        ...
        private void JumpToResult(int resultType)
        {
            try
            {
                ...
                window._item = _item;
                window._firstATs = _firstATs;
                window._lastATs = _lastATs;
                window._preHeatms = _preHeatms;
                window._realHeatms = _realHeatms;
                if (resultType == 1)
