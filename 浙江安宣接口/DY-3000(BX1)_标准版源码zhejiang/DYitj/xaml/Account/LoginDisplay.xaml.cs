        ...
        private UIElement GenerateItemBriefLayout(UserAccount item)
        {
            try
            {
                ...
                if (Global.IsEnableWswOrAtp)
                {
                    ...
                    wrapPannelMicrobial.Height = 30;
                    labelMicrobial = new Label();
                    labelMicrobial.Width = 100;
                    labelMicrobial.Height = 26;
