...
namespace AIO.xaml.Dialog
{
    ...
    public partial class FoodCategoriesWindow : Window
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            //2016
            nodes = new List<Node>();
            DataTable dtbl = SqlHelper.GetDataTable("tFoodSpecies", "Years='2016'", out errMsg);
            ...
            //2017
            nodes = new List<Node>();
            dtbl = SqlHelper.GetDataTable("tFoodSpecies", "Years='2017'", out errMsg);
            if (dtbl != null && dtbl.Rows.Count > 0)
            {
                nodes = (List<Node>)IListDataSet.DataTableToIList<Node>(dtbl);
        ...
        private void TxtName_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            if (tabControl.SelectedIndex == 0)//2016
            {
            ...
            else if (tabControl.SelectedIndex == 1)//2017
            {
