    ...
    public partial class SearchSampleidWindow : Window
    {
        ...
        private void SearchCloud()
        {
            try
            {
                ...
                {
                    MessageBox.Show("未在云平台上检索到该快检单号，请确认快检单号无误?", "操作提示", MessageBoxButton.OK, MessageBoxImage.Question);
        ...
        /// </summary>
        private bool Search(String whereSql, String orderBySql, int type)
        {
