...
namespace AIO
{
    ...
    public class DYFGDItemPara
    {
        ...
        public class DYDNPara
        {
            ...
            public double dnn= double.MinValue; // 农残有个对照deltaA
        }
        // 系数法 coefficient
        [Serializable]
        public class DYCOPara
        {
            ...
            public double coeff = double.MinValue; // 农残有个对照deltaA
        }
        [Serializable]
    ...
    public class DYJTJItemPara
    {
        ...
        {
            public double PlusT;
            public double MinusT;
            public double SuspiciousMax;
            public double SuspiciousMin;
            public double Abs;
            public int SetIdx;
            /// <summary>
            /// 胶体金判定C值需要的连续下降沿点数
            ...
            /// T值Nin前面的有效面积点数
            /// </summary>
            public int beforeAreaTNum;
            /// <summary>
            /// T值Nin后面的有效面积点数
            /// </summary>
            public int afterAreaTNum;
        }
        [Serializable]
        public class HoleSettings
        {
    ...
    public class DYGSZItemPara
    {
        ...
        public class DYCALPara
        {
            public int RGBSelPlus;
            public int RGBSelMinus;
            public int ComparePlus;
            public int CompareMinus;
            public double PlusT;
            public double MinusT;
        }
        [Serializable]
